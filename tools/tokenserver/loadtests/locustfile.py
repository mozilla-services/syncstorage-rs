...
class TokenserverTestUser(HttpUser):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.client_state = binascii.hexlify(self.generation_counter.to_bytes(16, "big")).decode(
            "utf8"
        )
    ...
    def _make_oauth_token(self, email, key=VALID_OAUTH_PRIVATE_KEY, **fields):
        ...
        return jwt.encode(body, key, algorithm="RS256", headers={"typ": "application/at+jwt"})
