...
class TestNodeAssignment(TestCase, unittest.TestCase):
    ...
    def test_new_user_allocation(self):
        ...
        self._add_node(available=100, current_load=0, capacity=100, downed=1, node="https://node2")
        node_id = self._add_node(available=99, current_load=1, capacity=100, node="https://node3")
    ...
    def test_successfully_releasing_node_capacity(self):
        ...
        node_id1 = self._add_node(available=0, current_load=99, capacity=100, node="https://node1")
        node_id2 = self._add_node(available=0, current_load=90, capacity=100, node="https://node2")
        node_id3 = self._add_node(available=0, current_load=80, capacity=81, node="https://node3")
    ...
    def test_unsuccessfully_releasing_node_capacity(self):
        ...
        self._add_node(available=0, current_load=100, capacity=100, node="https://node1")
