...
class TestCase:
    ...
    def _add_node(
        ...
        data = (self.service_id, node, available, capacity, current_load, backoff, downed)
    ...
    def _get_node(self, id):
        ...
        (id, service, node, available, current_load, capacity, downed, backoff) = cursor.fetchone()
        cursor.close()
