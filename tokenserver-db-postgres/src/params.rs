//! Parameter definitions for Postgres DB methods.
...
/// These parameters are used to update a user record.
/// `generation` and `keys_changed_at` are applied to
