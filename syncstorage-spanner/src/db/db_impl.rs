...
impl Db for SpannerDb {
    ...
    async fn commit(&mut self) -> Result<(), Self::Error> {
        SpannerDb::commit(self).await
    }

    async fn rollback(&mut self) -> Result<(), Self::Error> {
        SpannerDb::rollback(self).await
    }

    async fn lock_for_read(&mut self, param: params::LockCollection) -> Result<(), Self::Error> {
        SpannerDb::lock_for_read(self, param).await
    }

    async fn lock_for_write(&mut self, param: params::LockCollection) -> Result<(), Self::Error> {
        SpannerDb::lock_for_write(self, param).await
    }

    async fn begin(&mut self, for_write: bool) -> Result<(), Self::Error> {
        SpannerDb::begin(self, for_write).await
    }
    ...
    async fn get_collection_timestamp(
        ...
        SpannerDb::get_collection_timestamp(self, param).await
    }
    ...
    async fn get_storage_timestamp(
        ...
        SpannerDb::get_storage_timestamp(self, param).await
    }
    ...
    async fn delete_collection(
        ...
        SpannerDb::delete_collection(self, param).await
    }

    async fn check(&mut self) -> Result<results::Check, Self::Error> {
        SpannerDb::check(self).await
    }
    ...
    async fn get_collection_timestamps(
        ...
        SpannerDb::get_collection_timestamps(self, user_id).await
    }
    ...
    async fn get_collection_counts(
        ...
        SpannerDb::get_collection_counts(self, user_id).await
    }
    ...
    async fn get_collection_usage(
        ...
        SpannerDb::get_collection_usage(self, user_id).await
    }
    ...
    async fn get_storage_usage(
        ...
        SpannerDb::get_storage_usage(self, param).await
    }
    ...
    async fn get_quota_usage(
        ...
        SpannerDb::get_quota_usage(self, param).await
    }
    ...
    async fn delete_storage(
        ...
        SpannerDb::delete_storage(self, param).await
    }
    ...
    async fn delete_bso(
        ...
        SpannerDb::delete_bso(self, param).await
    }
    ...
    async fn delete_bsos(
        ...
        SpannerDb::delete_bsos(self, param).await
    }

    async fn get_bsos(&mut self, param: params::GetBsos) -> Result<results::GetBsos, Self::Error> {
        SpannerDb::get_bsos(self, param).await
    }
    ...
    async fn get_bso_ids(
        ...
        SpannerDb::get_bso_ids(self, param).await
    }
    ...
    async fn get_bso(
        ...
        SpannerDb::get_bso(self, param).await
    }
    ...
    async fn get_bso_timestamp(
        ...
        SpannerDb::get_bso_timestamp(self, param).await
    }

    async fn put_bso(&mut self, param: params::PutBso) -> Result<results::PutBso, Self::Error> {
        SpannerDb::put_bso(self, param).await
    }

    async fn post_bsos(&mut self, param: params::PostBsos) -> Result<SyncTimestamp, Self::Error> {
        SpannerDb::post_bsos(self, param).await
    }
    ...
    async fn get_collection_id(&mut self, name: String) -> Result<i32, Self::Error> {
        SpannerDb::get_collection_id(self, &name).await
    }
    ...
    async fn create_collection(&mut self, name: String) -> Result<i32, Self::Error> {
        SpannerDb::create_collection(self, &name).await
    }
