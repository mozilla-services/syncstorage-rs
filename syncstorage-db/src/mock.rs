...
impl Db for MockDb {
    ...
    async fn get_collection_timestamps(
        ...
        Ok(results::GetCollectionTimestamps::default())
    }
    ...
    async fn get_collection_timestamp(
        ...
        Ok(results::GetCollectionTimestamp::default())
    }
    ...
    async fn get_collection_counts(
        ...
        Ok(results::GetCollectionCounts::default())
    }
    ...
    async fn get_collection_usage(
        ...
        Ok(results::GetCollectionUsage::default())
    }
    ...
    async fn get_storage_usage(
        ...
        Ok(results::GetStorageUsage::default())
    }
    ...
    async fn delete_collection(
        ...
        Ok(results::DeleteCollection::default())
    }
    ...
    async fn create_batch(
        ...
        Ok(results::CreateBatch::default())
    }
    ...
    async fn validate_batch(
        ...
        Ok(results::ValidateBatch::default())
    }
    ...
    async fn commit_batch(
        ...
        Ok(results::CommitBatch::default())
    }
    ...
    async fn get_collection_id(
        ...
        Ok(results::GetCollectionId::default())
    }
    ...
    async fn create_collection(
        ...
        Ok(results::CreateCollection::default())
    }
    ...
    async fn update_collection(
        ...
        Ok(results::UpdateCollection::default())
    }
