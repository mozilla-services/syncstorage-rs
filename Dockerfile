...
# TODO: add back in the --release flag
# I removed it to see if it helps with logging out of the container
RUN cargo chef cook --no-default-features --features=syncstorage-db/$DATABASE_BACKEND --features=py_verifier --recipe-path recipe.json
