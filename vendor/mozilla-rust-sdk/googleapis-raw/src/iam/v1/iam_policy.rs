...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    m.V1\xca\x02\x13Google\\Cloud\\Iam\\V1J\xb5\x20\n\x06\x12\x04\x0e\0v\x01\
    ...
    \x12\x03R\x14\x15\n\xf3\x01\n\x04\x04\0\x02\x01\x12\x03X\x02\x14\x1a\xe5\
    \x01\x20REQUIRED:\x20The\x20complete\x20policy\x20to\x20be\x20applied\
    \x20to\x20the\x20`resource`.\x20The\x20size\x20of\n\x20the\x20policy\x20\
    is\x20limited\x20to\x20a\x20few\x2010s\x20of\x20KB.\x20An\x20empty\x20po\
    licy\x20is\x20a\n\x20valid\x20policy\x20but\x20certain\x20Cloud\x20Platf\
    orm\x20services\x20(such\x20as\x20Projects)\n\x20might\x20reject\x20them\
    .\n\n\x0c\n\x05\x04\0\x02\x01\x06\x12\x03X\x02\x08\n\x0c\n\x05\x04\0\x02\
    \x01\x01\x12\x03X\t\x0f\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03X\x12\x13\n\
    8\n\x02\x04\x01\x12\x04\\\0a\x01\x1a,\x20Request\x20message\x20for\x20`G\
    etIamPolicy`\x20method.\n\n\n\n\x03\x04\x01\x01\x12\x03\\\x08\x1b\n\xc2\
    \x01\n\x04\x04\x01\x02\0\x12\x03`\x02\x16\x1a\xb4\x01\x20REQUIRED:\x20Th\
    e\x20resource\x20for\x20which\x20the\x20policy\x20is\x20being\x20request\
    ed.\n\x20`resource`\x20is\x20usually\x20specified\x20as\x20a\x20path.\
    \x20For\x20example,\x20a\x20Project\n\x20resource\x20is\x20specified\x20\
    as\x20`projects/{project}`.\n\n\x0c\n\x05\x04\x01\x02\0\x05\x12\x03`\x02\
    \x08\n\x0c\n\x05\x04\x01\x02\0\x01\x12\x03`\t\x11\n\x0c\n\x05\x04\x01\
    \x02\0\x03\x12\x03`\x14\x15\n>\n\x02\x04\x02\x12\x04d\0o\x01\x1a2\x20Req\
    uest\x20message\x20for\x20`TestIamPermissions`\x20method.\n\n\n\n\x03\
    \x04\x02\x01\x12\x03d\x08!\n\xc9\x01\n\x04\x04\x02\x02\0\x12\x03h\x02\
    \x16\x1a\xbb\x01\x20REQUIRED:\x20The\x20resource\x20for\x20which\x20the\
    \x20policy\x20detail\x20is\x20being\x20requested.\n\x20`resource`\x20is\
    \x20usually\x20specified\x20as\x20a\x20path.\x20For\x20example,\x20a\x20\
    ...
    \n\xf0\x01\n\x04\x04\x02\x02\x01\x12\x03n\x02\"\x1a\xe2\x01\x20The\x20se\
    t\x20of\x20permissions\x20to\x20check\x20for\x20the\x20`resource`.\x20Pe\
    rmissions\x20with\n\x20wildcards\x20(such\x20as\x20'*'\x20or\x20'storage\
    .*')\x20are\x20not\x20allowed.\x20For\x20more\n\x20information\x20see\n\
    \x20[IAM\x20Overview](https://cloud.google.com/iam/docs/overview#permiss\
    ions).\n\n\x0c\n\x05\x04\x02\x02\x01\x04\x12\x03n\x02\n\n\x0c\n\x05\x04\
    \x02\x02\x01\x05\x12\x03n\x0b\x11\n\x0c\n\x05\x04\x02\x02\x01\x01\x12\
    \x03n\x12\x1d\n\x0c\n\x05\x04\x02\x02\x01\x03\x12\x03n\x20!\n?\n\x02\x04\
    \x03\x12\x04r\0v\x01\x1a3\x20Response\x20message\x20for\x20`TestIamPermi\
    ssions`\x20method.\n\n\n\n\x03\x04\x03\x01\x12\x03r\x08\"\n\\\n\x04\x04\
    \x03\x02\0\x12\x03u\x02\"\x1aO\x20A\x20subset\x20of\x20`TestPermissionsR\
    equest.permissions`\x20that\x20the\x20caller\x20is\n\x20allowed.\n\n\x0c\
