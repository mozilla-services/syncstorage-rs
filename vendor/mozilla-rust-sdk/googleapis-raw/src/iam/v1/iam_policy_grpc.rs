...
const METHOD_IAM_POLICY_SET_IAM_POLICY: ::grpcio::Method<
...
const METHOD_IAM_POLICY_GET_IAM_POLICY: ::grpcio::Method<
...
const METHOD_IAM_POLICY_TEST_IAM_PERMISSIONS: ::grpcio::Method<
...
impl IamPolicyClient {
    ...
    pub fn set_iam_policy_opt(
        ...
        self.client
            .unary_call(&METHOD_IAM_POLICY_SET_IAM_POLICY, req, opt)
    }
    ...
    pub fn set_iam_policy_async_opt(
        ...
        self.client
            .unary_call_async(&METHOD_IAM_POLICY_SET_IAM_POLICY, req, opt)
    }
    ...
    pub fn get_iam_policy_opt(
        ...
        self.client
            .unary_call(&METHOD_IAM_POLICY_GET_IAM_POLICY, req, opt)
    }
    ...
    pub fn get_iam_policy_async_opt(
        ...
        self.client
            .unary_call_async(&METHOD_IAM_POLICY_GET_IAM_POLICY, req, opt)
    }
    ...
    pub fn test_iam_permissions_opt(
        ...
        self.client
            .unary_call(&METHOD_IAM_POLICY_TEST_IAM_PERMISSIONS, req, opt)
    }
    ...
    > {
        self.client
            .unary_call_async(&METHOD_IAM_POLICY_TEST_IAM_PERMISSIONS, req, opt)
    }
...
pub fn create_iam_policy<S: IamPolicy + Send + Clone + 'static>(s: S) -> ::grpcio::Service {
    ...
    builder = builder
        .add_unary_handler(&METHOD_IAM_POLICY_SET_IAM_POLICY, move |ctx, req, resp| {
            instance.set_iam_policy(ctx, req, resp)
        });
    let mut instance = s.clone();
    builder = builder
        .add_unary_handler(&METHOD_IAM_POLICY_GET_IAM_POLICY, move |ctx, req, resp| {
            instance.get_iam_policy(ctx, req, resp)
        });
    let mut instance = s;
    builder = builder.add_unary_handler(
        &METHOD_IAM_POLICY_TEST_IAM_PERMISSIONS,
