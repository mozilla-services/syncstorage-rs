...
impl ::protobuf::Message for PolicyDelta {
    ...
    fn default_instance() -> &'static PolicyDelta {
        static mut instance: ::protobuf::lazy::Lazy<PolicyDelta> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const PolicyDelta,
        };
        unsafe {
...
impl ::protobuf::Message for BindingDelta {
    ...
    fn default_instance() -> &'static BindingDelta {
        static mut instance: ::protobuf::lazy::Lazy<BindingDelta> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const BindingDelta,
        };
        unsafe {
