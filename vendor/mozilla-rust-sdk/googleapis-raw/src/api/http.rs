...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    otations\xf8\x01\x01\xa2\x02\x04GAPIJ\x8et\n\x07\x12\x05\x0f\0\xf7\x02\
    ...
    \x02\x04\x01\x12\x06\xb9\x02\0\xee\x02\x01\x1a\xa4S\x20#\x20gRPC\x20Tran\
    scoding\n\n\x20gRPC\x20Transcoding\x20is\x20a\x20feature\x20for\x20mappi\
    ng\x20between\x20a\x20gRPC\x20method\x20and\x20one\x20or\n\x20more\x20HT\
    TP\x20REST\x20endpoints.\x20It\x20allows\x20developers\x20to\x20build\
    \x20a\x20single\x20API\x20service\n\x20that\x20supports\x20both\x20gRPC\
    \x20APIs\x20and\x20REST\x20APIs.\x20Many\x20systems,\x20including\x20[Go\
    ogle\n\x20APIs](https://github.com/googleapis/googleapis),\n\x20[Cloud\
    \x20Endpoints](https://cloud.google.com/endpoints),\x20[gRPC\n\x20Gatewa\
    y](https://github.com/grpc-ecosystem/grpc-gateway),\n\x20and\x20[Envoy](\
    https://github.com/envoyproxy/envoy)\x20proxy\x20support\x20this\x20feat\
    ure\n\x20and\x20use\x20it\x20for\x20large\x20scale\x20production\x20serv\
    ices.\n\n\x20`HttpRule`\x20defines\x20the\x20schema\x20of\x20the\x20gRPC\
    /REST\x20mapping.\x20The\x20mapping\x20specifies\n\x20how\x20different\
    \x20portions\x20of\x20the\x20gRPC\x20request\x20message\x20are\x20mapped\
    \x20to\x20the\x20URL\n\x20path,\x20URL\x20query\x20parameters,\x20and\
    \x20HTTP\x20request\x20body.\x20It\x20also\x20controls\x20how\x20the\n\
    \x20gRPC\x20response\x20message\x20is\x20mapped\x20to\x20the\x20HTTP\x20\
    response\x20body.\x20`HttpRule`\x20is\n\x20typically\x20specified\x20as\
    \x20an\x20`google.api.http`\x20annotation\x20on\x20the\x20gRPC\x20method\
    .\n\n\x20Each\x20mapping\x20specifies\x20a\x20URL\x20path\x20template\
    \x20and\x20an\x20HTTP\x20method.\x20The\x20path\n\x20template\x20may\x20\
    refer\x20to\x20one\x20or\x20more\x20fields\x20in\x20the\x20gRPC\x20reque\
    st\x20message,\x20as\x20long\n\x20as\x20each\x20field\x20is\x20a\x20non-\
    repeated\x20field\x20with\x20a\x20primitive\x20(non-message)\x20type.\n\
    \x20The\x20path\x20template\x20controls\x20how\x20fields\x20of\x20the\
    \x20request\x20message\x20are\x20mapped\x20to\n\x20the\x20URL\x20path.\n\
    ...
    \x20get:\x20\"/v1/{name=messages/*}\"\n\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20};\n\x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20}\n\x20\x20\
    \x20\x20\x20message\x20GetMessageRequest\x20{\n\x20\x20\x20\x20\x20\x20\
    \x20string\x20name\x20=\x201;\x20//\x20Mapped\x20to\x20URL\x20path.\n\
    \x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20message\x20Message\x20{\n\x20\
    \x20\x20\x20\x20\x20\x20string\x20text\x20=\x201;\x20//\x20The\x20resour\
    ce\x20content.\n\x20\x20\x20\x20\x20}\n\n\x20This\x20enables\x20an\x20HT\
    TP\x20REST\x20to\x20gRPC\x20mapping\x20as\x20below:\n\n\x20HTTP\x20|\x20\
    gRPC\n\x20-----|-----\n\x20`GET\x20/v1/messages/123456`\x20\x20|\x20`Get\
    Message(name:\x20\"messages/123456\")`\n\n\x20Any\x20fields\x20in\x20the\
    \x20request\x20message\x20which\x20are\x20not\x20bound\x20by\x20the\x20p\
    ath\x20template\n\x20automatically\x20become\x20HTTP\x20query\x20paramet\
    ers\x20if\x20there\x20is\x20no\x20HTTP\x20request\x20body.\n\x20For\x20e\
    xample:\n\n\x20\x20\x20\x20\x20service\x20Messaging\x20{\n\x20\x20\x20\
    \x20\x20\x20\x20rpc\x20GetMessage(GetMessageRequest)\x20returns\x20(Mess\
    age)\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20option\x20(google.api.htt\
    p)\x20=\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20get:\"\
    /v1/messages/{message_id}\"\n\x20\x20\x20\x20\x20\x20\x20\x20\x20};\n\
    \x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\
    \x20message\x20GetMessageRequest\x20{\n\x20\x20\x20\x20\x20\x20\x20messa\
    ge\x20SubMessage\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20string\x20sub\
    field\x20=\x201;\n\x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20\
    \x20\x20string\x20message_id\x20=\x201;\x20//\x20Mapped\x20to\x20URL\x20\
    path.\n\x20\x20\x20\x20\x20\x20\x20int64\x20revision\x20=\x202;\x20\x20\
    \x20\x20//\x20Mapped\x20to\x20URL\x20query\x20parameter\x20`revision`.\n\
    \x20\x20\x20\x20\x20\x20\x20SubMessage\x20sub\x20=\x203;\x20\x20\x20\x20\
    //\x20Mapped\x20to\x20URL\x20query\x20parameter\x20`sub.subfield`.\n\x20\
    \x20\x20\x20\x20}\n\n\x20This\x20enables\x20a\x20HTTP\x20JSON\x20to\x20R\
    PC\x20mapping\x20as\x20below:\n\n\x20HTTP\x20|\x20gRPC\n\x20-----|-----\
    \n\x20`GET\x20/v1/messages/123456?revision=2&sub.subfield=foo`\x20|\n\
    \x20`GetMessage(message_id:\x20\"123456\"\x20revision:\x202\x20sub:\x20S\
    ubMessage(subfield:\n\x20\"foo\"))`\n\n\x20Note\x20that\x20fields\x20whi\
    ch\x20are\x20mapped\x20to\x20URL\x20query\x20parameters\x20must\x20have\
    \x20a\n\x20primitive\x20type\x20or\x20a\x20repeated\x20primitive\x20type\
    \x20or\x20a\x20non-repeated\x20message\x20type.\n\x20In\x20the\x20case\
    \x20of\x20a\x20repeated\x20type,\x20the\x20parameter\x20can\x20be\x20rep\
    eated\x20in\x20the\x20URL\n\x20as\x20`...?param=A&param=B`.\x20In\x20the\
    \x20case\x20of\x20a\x20message\x20type,\x20each\x20field\x20of\x20the\n\
    \x20message\x20is\x20mapped\x20to\x20a\x20separate\x20parameter,\x20such\
    \x20as\n\x20`...?foo.a=A&foo.b=B&foo.c=C`.\n\n\x20For\x20HTTP\x20methods\
    \x20that\x20allow\x20a\x20request\x20body,\x20the\x20`body`\x20field\n\
    ...
    {\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20patch:\x20\"/v1/messages/\
    {message_id}\"\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20body:\x20\"m\
    essage\"\n\x20\x20\x20\x20\x20\x20\x20\x20\x20};\n\x20\x20\x20\x20\x20\
    \x20\x20}\n\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20message\x20UpdateM\
    essageRequest\x20{\n\x20\x20\x20\x20\x20\x20\x20string\x20message_id\x20\
    =\x201;\x20//\x20mapped\x20to\x20the\x20URL\n\x20\x20\x20\x20\x20\x20\
    \x20Message\x20message\x20=\x202;\x20\x20\x20//\x20mapped\x20to\x20the\
    \x20body\n\x20\x20\x20\x20\x20}\n\n\x20The\x20following\x20HTTP\x20JSON\
    \x20to\x20RPC\x20mapping\x20is\x20enabled,\x20where\x20the\n\x20represen\
    tation\x20of\x20the\x20JSON\x20in\x20the\x20request\x20body\x20is\x20det\
    ermined\x20by\n\x20protos\x20JSON\x20encoding:\n\n\x20HTTP\x20|\x20gRPC\
    \n\x20-----|-----\n\x20`PATCH\x20/v1/messages/123456\x20{\x20\"text\":\
    \x20\"Hi!\"\x20}`\x20|\x20`UpdateMessage(message_id:\n\x20\"123456\"\x20\
    message\x20{\x20text:\x20\"Hi!\"\x20})`\n\n\x20The\x20special\x20name\
    \x20`*`\x20can\x20be\x20used\x20in\x20the\x20body\x20mapping\x20to\x20de\
    fine\x20that\n\x20every\x20field\x20not\x20bound\x20by\x20the\x20path\
    \x20template\x20should\x20be\x20mapped\x20to\x20the\n\x20request\x20body\
    .\x20\x20This\x20enables\x20the\x20following\x20alternative\x20definitio\
    n\x20of\n\x20the\x20update\x20method:\n\n\x20\x20\x20\x20\x20service\x20\
    Messaging\x20{\n\x20\x20\x20\x20\x20\x20\x20rpc\x20UpdateMessage(Message\
    )\x20returns\x20(Message)\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20opti\
    on\x20(google.api.http)\x20=\x20{\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20patch:\x20\"/v1/messages/{message_id}\"\n\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20body:\x20\"*\"\n\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20};\n\x20\x20\x20\x20\x20\x20\x20}\n\x20\x20\x20\x20\x20}\n\x20\x20\
    \x20\x20\x20message\x20Message\x20{\n\x20\x20\x20\x20\x20\x20\x20string\
    \x20message_id\x20=\x201;\n\x20\x20\x20\x20\x20\x20\x20string\x20text\
    ...
    **\"\x20|\x20LITERAL\x20|\x20Variable\x20;\n\x20\x20\x20\x20\x20Variable\
    ...
    \x0f\n\x05\x04\x01\x02\0\x04\x12\x06\xbd\x02\x02\xb9\x02\x12\n\r\n\x05\
    \x04\x01\x02\0\x05\x12\x04\xbd\x02\x02\x08\n\r\n\x05\x04\x01\x02\0\x01\
    \x12\x04\xbd\x02\t\x11\n\r\n\x05\x04\x01\x02\0\x03\x12\x04\xbd\x02\x14\
    \x15\n\xd0\x01\n\x04\x04\x01\x08\0\x12\x06\xc2\x02\x02\xd8\x02\x03\x1a\
    ...
    \x01\x02\x01\x12\x04\xc5\x02\x04\x13\x1aN\x20Maps\x20to\x20HTTP\x20GET.\
    ...
    \x01\x03\x12\x04\xc5\x02\x11\x12\n@\n\x04\x04\x01\x02\x02\x12\x04\xc8\
    \x02\x04\x13\x1a2\x20Maps\x20to\x20HTTP\x20PUT.\x20Used\x20for\x20replac\
    ing\x20a\x20resource.\n\n\r\n\x05\x04\x01\x02\x02\x05\x12\x04\xc8\x02\
    \x04\n\n\r\n\x05\x04\x01\x02\x02\x01\x12\x04\xc8\x02\x0b\x0e\n\r\n\x05\
    \x04\x01\x02\x02\x03\x12\x04\xc8\x02\x11\x12\nX\n\x04\x04\x01\x02\x03\
    \x12\x04\xcb\x02\x04\x14\x1aJ\x20Maps\x20to\x20HTTP\x20POST.\x20Used\x20\
    for\x20creating\x20a\x20resource\x20or\x20performing\x20an\x20action.\n\
    \n\r\n\x05\x04\x01\x02\x03\x05\x12\x04\xcb\x02\x04\n\n\r\n\x05\x04\x01\
    \x02\x03\x01\x12\x04\xcb\x02\x0b\x0f\n\r\n\x05\x04\x01\x02\x03\x03\x12\
    \x04\xcb\x02\x12\x13\nB\n\x04\x04\x01\x02\x04\x12\x04\xce\x02\x04\x16\
    ...
    \x04\x03\x12\x04\xce\x02\x14\x15\nA\n\x04\x04\x01\x02\x05\x12\x04\xd1\
    \x02\x04\x15\x1a3\x20Maps\x20to\x20HTTP\x20PATCH.\x20Used\x20for\x20upda\
    ting\x20a\x20resource.\n\n\r\n\x05\x04\x01\x02\x05\x05\x12\x04\xd1\x02\
    \x04\n\n\r\n\x05\x04\x01\x02\x05\x01\x12\x04\xd1\x02\x0b\x10\n\r\n\x05\
    \x04\x01\x02\x05\x03\x12\x04\xd1\x02\x13\x14\n\x98\x02\n\x04\x04\x01\x02\
    \x06\x12\x04\xd7\x02\x04!\x1a\x89\x02\x20The\x20custom\x20pattern\x20is\
    ...
    \x02\x06\x03\x12\x04\xd7\x02\x1f\x20\n\xc4\x02\n\x04\x04\x01\x02\x07\x12\
    \x04\xe0\x02\x02\x12\x1a\xb5\x02\x20The\x20name\x20of\x20the\x20request\
    ...
    ge\x20type.\n\n\x0f\n\x05\x04\x01\x02\x07\x04\x12\x06\xe0\x02\x02\xd8\
    \x02\x03\n\r\n\x05\x04\x01\x02\x07\x05\x12\x04\xe0\x02\x02\x08\n\r\n\x05\
    \x04\x01\x02\x07\x01\x12\x04\xe0\x02\t\r\n\r\n\x05\x04\x01\x02\x07\x03\
    \x12\x04\xe0\x02\x10\x11\n\x99\x02\n\x04\x04\x01\x02\x08\x12\x04\xe8\x02\
    ...
    \x0f\n\x05\x04\x01\x02\x08\x04\x12\x06\xe8\x02\x02\xe0\x02\x12\n\r\n\x05\
    \x04\x01\x02\x08\x05\x12\x04\xe8\x02\x02\x08\n\r\n\x05\x04\x01\x02\x08\
    \x01\x12\x04\xe8\x02\t\x16\n\r\n\x05\x04\x01\x02\x08\x03\x12\x04\xe8\x02\
    \x19\x1b\n\xbb\x01\n\x04\x04\x01\x02\t\x12\x04\xed\x02\x02-\x1a\xac\x01\
    ...
    \x12\x04\xed\x02*,\nG\n\x02\x04\x02\x12\x06\xf1\x02\0\xf7\x02\x01\x1a9\
    \x20A\x20custom\x20pattern\x20is\x20used\x20for\x20defining\x20custom\
    \x20HTTP\x20verb.\n\n\x0b\n\x03\x04\x02\x01\x12\x04\xf1\x02\x08\x19\n2\n\
    \x04\x04\x02\x02\0\x12\x04\xf3\x02\x02\x12\x1a$\x20The\x20name\x20of\x20\
    this\x20custom\x20HTTP\x20verb.\n\n\x0f\n\x05\x04\x02\x02\0\x04\x12\x06\
    \xf3\x02\x02\xf1\x02\x1b\n\r\n\x05\x04\x02\x02\0\x05\x12\x04\xf3\x02\x02\
    \x08\n\r\n\x05\x04\x02\x02\0\x01\x12\x04\xf3\x02\t\r\n\r\n\x05\x04\x02\
    \x02\0\x03\x12\x04\xf3\x02\x10\x11\n5\n\x04\x04\x02\x02\x01\x12\x04\xf6\
    \x02\x02\x12\x1a'\x20The\x20path\x20matched\x20by\x20this\x20custom\x20v\
    erb.\n\n\x0f\n\x05\x04\x02\x02\x01\x04\x12\x06\xf6\x02\x02\xf3\x02\x12\n\
    \r\n\x05\x04\x02\x02\x01\x05\x12\x04\xf6\x02\x02\x08\n\r\n\x05\x04\x02\
    \x02\x01\x01\x12\x04\xf6\x02\t\r\n\r\n\x05\x04\x02\x02\x01\x03\x12\x04\
    \xf6\x02\x10\x11b\x06proto3\
";
