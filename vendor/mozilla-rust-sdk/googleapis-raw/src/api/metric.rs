...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    oto/googleapis/api/metric;metric\xa2\x02\x04GAPIJ\xfeN\n\x07\x12\x05\x0f\
    ...
    \x02\n\x06\x04\0\x03\0\x02\x01\x12\x03+\x04/\x1a\xfa\x01\x20The\x20sampl\
    ing\x20period\x20of\x20metric\x20data\x20points.\x20For\x20metrics\x20wh\
    ich\x20are\x20written\n\x20periodically,\x20consecutive\x20data\x20point\
    s\x20are\x20stored\x20at\x20this\x20time\x20interval,\n\x20excluding\x20\
    data\x20loss\x20due\x20to\x20errors.\x20Metrics\x20with\x20a\x20higher\
    \x20granularity\x20have\n\x20a\x20smaller\x20sampling\x20period.\n\n\x0f\
    \n\x07\x04\0\x03\0\x02\x01\x04\x12\x04+\x04%5\n\x0e\n\x07\x04\0\x03\0\
    \x02\x01\x06\x12\x03+\x04\x1c\n\x0e\n\x07\x04\0\x03\0\x02\x01\x01\x12\
    \x03+\x1d*\n\x0e\n\x07\x04\0\x03\0\x02\x01\x03\x12\x03+-.\n\xbc\x01\n\
    \x06\x04\0\x03\0\x02\x02\x12\x030\x04.\x1a\xac\x01\x20The\x20delay\x20of\
    \x20data\x20points\x20caused\x20by\x20ingestion.\x20Data\x20points\x20ol\
    der\x20than\x20this\n\x20age\x20are\x20guaranteed\x20to\x20be\x20ingeste\
    d\x20and\x20available\x20to\x20be\x20read,\x20excluding\n\x20data\x20los\
    s\x20due\x20to\x20errors.\n\n\x0f\n\x07\x04\0\x03\0\x02\x02\x04\x12\x040\
    \x04+/\n\x0e\n\x07\x04\0\x03\0\x02\x02\x06\x12\x030\x04\x1c\n\x0e\n\x07\
    \x04\0\x03\0\x02\x02\x01\x12\x030\x1d)\n\x0e\n\x07\x04\0\x03\0\x02\x02\
    \x03\x12\x030,-\nO\n\x04\x04\0\x04\0\x12\x044\x02D\x03\x1aA\x20The\x20ki\
    nd\x20of\x20measurement.\x20It\x20describes\x20how\x20the\x20data\x20is\
    \x20reported.\n\n\x0c\n\x05\x04\0\x04\0\x01\x12\x034\x07\x11\n/\n\x06\
    \x04\0\x04\0\x02\0\x12\x036\x04\x20\x1a\x20\x20Do\x20not\x20use\x20this\
    \x20default\x20value.\n\n\x0e\n\x07\x04\0\x04\0\x02\0\x01\x12\x036\x04\
    \x1b\n\x0e\n\x07\x04\0\x04\0\x02\0\x02\x12\x036\x1e\x1f\n9\n\x06\x04\0\
    \x04\0\x02\x01\x12\x039\x04\x0e\x1a*\x20An\x20instantaneous\x20measureme\
    nt\x20of\x20a\x20value.\n\n\x0e\n\x07\x04\0\x04\0\x02\x01\x01\x12\x039\
    ...
    \x02\x04\x03\x12\x03{\x19\x1a\n\xb3\x1e\n\x04\x04\0\x02\x05\x12\x04\xe3\
    \x01\x02\x12\x1a\xa4\x10\x20*\x20`Ki`\x20\x20\x20\x20kibi\x20\x20\x20\
    \x20(2^10)\n\x20*\x20`Mi`\x20\x20\x20\x20mebi\x20\x20\x20\x20(2^20)\n\
    \x20*\x20`Gi`\x20\x20\x20\x20gibi\x20\x20\x20\x20(2^30)\n\x20*\x20`Ti`\
    \x20\x20\x20\x20tebi\x20\x20\x20\x20(2^40)\n\x20*\x20`Pi`\x20\x20\x20\
    \x20pebi\x20\x20\x20\x20(2^50)\n\n\x20**Grammar**\n\n\x20The\x20grammar\
    \x20also\x20includes\x20these\x20connectors:\n\n\x20*\x20`/`\x20\x20\x20\
    \x20division\x20or\x20ratio\x20(as\x20an\x20infix\x20operator).\x20For\
    \x20examples,\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20`kBy/{email}`\x20\
    or\x20`MiBy/10ms`\x20(although\x20you\x20should\x20almost\x20never\n\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20have\x20`/s`\x20in\x20a\x20metric\
    \x20`unit`;\x20rates\x20should\x20always\x20be\x20computed\x20at\n\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20query\x20time\x20from\x20the\x20unde\
    rlying\x20cumulative\x20or\x20delta\x20value).\n\x20*\x20`.`\x20\x20\x20\
    \x20multiplication\x20or\x20composition\x20(as\x20an\x20infix\x20operato\
    r).\x20For\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20examples,\x20`GBy.d`\
    ...
    `UNIT`.\x20If\x20the\x20annotation\n\x20\x20\x20\x20is\x20used\x20alone,\
    \x20then\x20the\x20unit\x20is\x20equivalent\x20to\x20`1`.\x20For\x20exam\
    ples,\n\x20\x20\x20\x20`{request}/s\x20==\x201/s`,\x20`By{transmitted}/s\
    \x20==\x20By/s`.\n\x20*\x20`NAME`\x20is\x20a\x20sequence\x20of\x20non-bl\
    ank\x20printable\x20ASCII\x20characters\x20not\n\x20\x20\x20\x20containi\
    ng\x20`{`\x20or\x20`}`.\n\x20*\x20`1`\x20represents\x20a\x20unitary\x20[\
    dimensionless\n\x20\x20\x20\x20unit](https://en.wikipedia.org/wiki/Dimen\
    sionless_quantity)\x20of\x201,\x20such\n\x20\x20\x20\x20as\x20in\x20`1/s\
    `.\x20It\x20is\x20typically\x20used\x20when\x20none\x20of\x20the\x20basi\
    c\x20units\x20are\n\x20\x20\x20\x20appropriate.\x20For\x20example,\x20\"\
    new\x20users\x20per\x20day\"\x20can\x20be\x20represented\x20as\n\x20\x20\
    \x20\x20`1/d`\x20or\x20`{new-users}/d`\x20(and\x20a\x20metric\x20value\
    \x20`5`\x20would\x20mean\x20\"5\x20new\n\x20\x20\x20\x20users).\x20Alter\
    natively,\x20\"thousands\x20of\x20page\x20views\x20per\x20day\"\x20would\
    \x20be\n\x20\x20\x20\x20represented\x20as\x20`1000/d`\x20or\x20`k1/d`\
    \x20or\x20`k{page_views}/d`\x20(and\x20a\x20metric\n\x20\x20\x20\x20valu\
    e\x20of\x20`5.3`\x20would\x20mean\x20\"5300\x20page\x20views\x20per\x20d\
    ay\").\n\x20*\x20`%`\x20represents\x20dimensionless\x20value\x20of\x201/\
    100,\x20and\x20annotates\x20values\x20giving\n\x20\x20\x20\x20a\x20perce\
    ntage\x20(so\x20the\x20metric\x20values\x20are\x20typically\x20in\x20the\
    \x20range\x20of\x200..100,\n\x20\x20\x20\x20and\x20a\x20metric\x20value\
    \x20`3`\x20means\x20\"3\x20percent\").\n\x20*\x20`10^2.%`\x20indicates\
    \x20a\x20metric\x20contains\x20a\x20ratio,\x20typically\x20in\x20the\x20\
    range\n\x20\x20\x20\x200..1,\x20that\x20will\x20be\x20multiplied\x20by\
    \x20100\x20and\x20displayed\x20as\x20a\x20percentage\n\x20\x20\x20\x20(s\
    o\x20a\x20metric\x20value\x20`0.03`\x20means\x20\"3\x20percent\").\n\n2\
    \x9d\x0c\x20The\x20units\x20in\x20which\x20the\x20metric\x20value\x20is\
    \x20reported.\x20It\x20is\x20only\x20applicable\n\x20if\x20the\x20`value\
    _type`\x20is\x20`INT64`,\x20`DOUBLE`,\x20or\x20`DISTRIBUTION`.\x20The\
    \x20`unit`\n\x20defines\x20the\x20representation\x20of\x20the\x20stored\
    \x20metric\x20values.\n\n\x20Different\x20systems\x20may\x20scale\x20the\
    \x20values\x20to\x20be\x20more\x20easily\x20displayed\x20(so\x20a\n\x20v\
    alue\x20of\x20`0.02KBy`\x20_might_\x20be\x20displayed\x20as\x20`20By`,\
    \x20and\x20a\x20value\x20of\n\x20`3523KBy`\x20_might_\x20be\x20displayed\
    \x20as\x20`3.5MBy`).\x20However,\x20if\x20the\x20`unit`\x20is\n\x20`KBy`\
    ,\x20then\x20the\x20value\x20of\x20the\x20metric\x20is\x20always\x20in\
    \x20thousands\x20of\x20bytes,\x20no\n\x20matter\x20how\x20it\x20may\x20b\
    e\x20displayed..\n\n\x20If\x20you\x20want\x20a\x20custom\x20metric\x20to\
    \x20record\x20the\x20exact\x20number\x20of\x20CPU-seconds\x20used\n\x20b\
    y\x20a\x20job,\x20you\x20can\x20create\x20an\x20`INT64\x20CUMULATIVE`\
    \x20metric\x20whose\x20`unit`\x20is\n\x20`s{CPU}`\x20(or\x20equivalently\
    \x20`1s{CPU}`\x20or\x20just\x20`s`).\x20If\x20the\x20job\x20uses\x2012,0\
    05\n\x20CPU-seconds,\x20then\x20the\x20value\x20is\x20written\x20as\x20`\
    12005`.\n\n\x20Alternatively,\x20if\x20you\x20want\x20a\x20custome\x20me\
    tric\x20to\x20record\x20data\x20in\x20a\x20more\n\x20granular\x20way,\
    \x20you\x20can\x20create\x20a\x20`DOUBLE\x20CUMULATIVE`\x20metric\x20who\
    se\x20`unit`\x20is\n\x20`ks{CPU}`,\x20and\x20then\x20write\x20the\x20val\
    ue\x20`12.005`\x20(which\x20is\x20`12005/1000`),\n\x20or\x20use\x20`Kis{\
    CPU}`\x20and\x20write\x20`11.723`\x20(which\x20is\x20`12005/1024`).\n\n\
    \x20The\x20supported\x20units\x20are\x20a\x20subset\x20of\x20[The\x20Uni\
    fied\x20Code\x20for\x20Units\x20of\n\x20Measure](http://unitsofmeasure.o\
    rg/ucum.html)\x20standard:\n\n\x20**Basic\x20units\x20(UNIT)**\n\n\x20*\
    \x20`bit`\x20\x20\x20bit\n\x20*\x20`By`\x20\x20\x20\x20byte\n\x20*\x20`s\
    `\x20\x20\x20\x20\x20second\n\x20*\x20`min`\x20\x20\x20minute\n\x20*\x20\
    `h`\x20\x20\x20\x20\x20hour\n\x20*\x20`d`\x20\x20\x20\x20\x20day\n\n\x20\
    **Prefixes\x20(PREFIX)**\n\n\x20*\x20`k`\x20\x20\x20\x20\x20kilo\x20\x20\
    \x20\x20(10^3)\n\x20*\x20`M`\x20\x20\x20\x20\x20mega\x20\x20\x20\x20(10^\
    6)\n\x20*\x20`G`\x20\x20\x20\x20\x20giga\x20\x20\x20\x20(10^9)\n\x20*\
    \x20`T`\x20\x20\x20\x20\x20tera\x20\x20\x20\x20(10^12)\n\x20*\x20`P`\x20\
    \x20\x20\x20\x20peta\x20\x20\x20\x20(10^15)\n\x20*\x20`E`\x20\x20\x20\
    \x20\x20exa\x20\x20\x20\x20\x20(10^18)\n\x20*\x20`Z`\x20\x20\x20\x20\x20\
    zetta\x20\x20\x20(10^21)\n\x20*\x20`Y`\x20\x20\x20\x20\x20yotta\x20\x20\
    \x20(10^24)\n2\xdd\x01\x20*\x20`m`\x20\x20\x20\x20\x20milli\x20\x20\x20(\
    10^-3)\n\x20*\x20`u`\x20\x20\x20\x20\x20micro\x20\x20\x20(10^-6)\n\x20*\
    \x20`n`\x20\x20\x20\x20\x20nano\x20\x20\x20\x20(10^-9)\n\x20*\x20`p`\x20\
    \x20\x20\x20\x20pico\x20\x20\x20\x20(10^-12)\n\x20*\x20`f`\x20\x20\x20\
    \x20\x20femto\x20\x20\x20(10^-15)\n\x20*\x20`a`\x20\x20\x20\x20\x20atto\
    \x20\x20\x20\x20(10^-18)\n\x20*\x20`z`\x20\x20\x20\x20\x20zepto\x20\x20\
    \x20(10^-21)\n\x20*\x20`y`\x20\x20\x20\x20\x20yocto\x20\x20\x20(10^-24)\
    \n\n\x0e\n\x05\x04\0\x02\x05\x04\x12\x05\xe3\x01\x02{\x1b\n\r\n\x05\x04\
    \0\x02\x05\x05\x12\x04\xe3\x01\x02\x08\n\r\n\x05\x04\0\x02\x05\x01\x12\
    \x04\xe3\x01\t\r\n\r\n\x05\x04\0\x02\x05\x03\x12\x04\xe3\x01\x10\x11\nY\
    \n\x04\x04\0\x02\x06\x12\x04\xe6\x01\x02\x19\x1aK\x20A\x20detailed\x20de\
    scription\x20of\x20the\x20metric,\x20which\x20can\x20be\x20used\x20in\
    \x20documentation.\n\n\x0f\n\x05\x04\0\x02\x06\x04\x12\x06\xe6\x01\x02\
    \xe3\x01\x12\n\r\n\x05\x04\0\x02\x06\x05\x12\x04\xe6\x01\x02\x08\n\r\n\
    \x05\x04\0\x02\x06\x01\x12\x04\xe6\x01\t\x14\n\r\n\x05\x04\0\x02\x06\x03\
    \x12\x04\xe6\x01\x17\x18\n\xa3\x02\n\x04\x04\0\x02\x07\x12\x04\xec\x01\
    \x02\x1a\x1a\x94\x02\x20A\x20concise\x20name\x20for\x20the\x20metric,\
    \x20which\x20can\x20be\x20displayed\x20in\x20user\x20interfaces.\n\x20Us\
    e\x20sentence\x20case\x20without\x20an\x20ending\x20period,\x20for\x20ex\
    ample\x20\"Request\x20count\".\n\x20This\x20field\x20is\x20optional\x20b\
    ut\x20it\x20is\x20recommended\x20to\x20be\x20set\x20for\x20any\x20metric\
    s\n\x20associated\x20with\x20user-visible\x20concepts,\x20such\x20as\x20\
    Quota.\n\n\x0f\n\x05\x04\0\x02\x07\x04\x12\x06\xec\x01\x02\xe6\x01\x19\n\
    ...
    of\x20the\x20metric.\n\n\x0f\n\x05\x04\0\x02\x08\x04\x12\x06\xef\x01\x02\
    \xec\x01\x1a\n\r\n\x05\x04\0\x02\x08\x06\x12\x04\xef\x01\x02\x1a\n\r\n\
    \x05\x04\0\x02\x08\x01\x12\x04\xef\x01\x1b#\n\r\n\x05\x04\0\x02\x08\x03\
    \x12\x04\xef\x01&(\nD\n\x04\x04\0\x02\t\x12\x04\xf2\x01\x02\x20\x1a6\x20\
    Optional.\x20The\x20launch\x20stage\x20of\x20the\x20metric\x20definition\
    .\n\n\x0f\n\x05\x04\0\x02\t\x04\x12\x06\xf2\x01\x02\xef\x01)\n\r\n\x05\
    \x04\0\x02\t\x06\x12\x04\xf2\x01\x02\r\n\r\n\x05\x04\0\x02\t\x01\x12\x04\
    \xf2\x01\x0e\x1a\n\r\n\x05\x04\0\x02\t\x03\x12\x04\xf2\x01\x1d\x1f\n\x92\
    \x01\n\x02\x04\x01\x12\x06\xf7\x01\0\xff\x01\x01\x1a\x83\x01\x20A\x20spe\
    ...
    \xa4\x01\n\x04\x04\x01\x02\0\x12\x04\xfa\x01\x02\x12\x1a\x95\x01\x20An\
    ...
    \x0f\n\x05\x04\x01\x02\x01\x04\x12\x06\xfe\x01\x02\xfa\x01\x12\n\r\n\x05\
    \x04\x01\x02\x01\x06\x12\x04\xfe\x01\x02\x15\n\r\n\x05\x04\x01\x02\x01\
    \x01\x12\x04\xfe\x01\x16\x1c\n\r\n\x05\x04\x01\x02\x01\x03\x12\x04\xfe\
