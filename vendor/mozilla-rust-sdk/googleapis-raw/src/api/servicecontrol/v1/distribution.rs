...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x15\x1a\xb1\x01\x20The\x20i'th\x20linear\x20bucket\x20covers\x20the\x20\
    interval\n\x20\x20\x20[offset\x20+\x20(i-1)\x20*\x20width,\x20offset\x20\
    +\x20i\x20*\x20width)\n\x20where\x20i\x20ranges\x20from\x201\x20to\x20nu\
    m_finite_buckets,\x20inclusive.\n\x20Must\x20be\x20strictly\x20positive.\
    ...
    \xa5\x01\n\x06\x04\0\x03\0\x02\x02\x12\x031\x04\x16\x1a\x95\x01\x20The\
    \x20i'th\x20linear\x20bucket\x20covers\x20the\x20interval\n\x20\x20\x20[\
    offset\x20+\x20(i-1)\x20*\x20width,\x20offset\x20+\x20i\x20*\x20width)\n\
    \x20where\x20i\x20ranges\x20from\x201\x20to\x20num_finite_buckets,\x20in\
    clusive.\n\n\x0f\n\x07\x04\0\x03\0\x02\x02\x04\x12\x041\x04,\x15\n\x0e\n\
    \x07\x04\0\x03\0\x02\x02\x05\x12\x031\x04\n\n\x0e\n\x07\x04\0\x03\0\x02\
    \x02\x01\x12\x031\x0b\x11\n\x0e\n\x07\x04\0\x03\0\x02\x02\x03\x12\x031\
    \x14\x15\nD\n\x04\x04\0\x03\x01\x12\x045\x02F\x03\x1a6\x20Describing\x20\
    buckets\x20with\x20exponentially\x20growing\x20width.\n\n\x0c\n\x05\x04\
    \0\x03\x01\x01\x12\x035\n\x1c\n\xc1\x01\n\x06\x04\0\x03\x01\x02\0\x12\
    \x039\x04!\x1a\xb1\x01\x20The\x20number\x20of\x20finite\x20buckets.\x20W\
    ith\x20the\x20underflow\x20and\x20overflow\x20buckets,\n\x20the\x20total\
    ...
    \n\x07\x04\0\x03\x01\x02\0\x04\x12\x049\x045\x1e\n\x0e\n\x07\x04\0\x03\
    ...
    \x03\x01\x02\x01\x04\x12\x04?\x049!\n\x0e\n\x07\x04\0\x03\x01\x02\x01\
    \x05\x12\x03?\x04\n\n\x0e\n\x07\x04\0\x03\x01\x02\x01\x01\x12\x03?\x0b\
    \x18\n\x0e\n\x07\x04\0\x03\x01\x02\x01\x03\x12\x03?\x1b\x1c\n\xc1\x01\n\
    \x06\x04\0\x03\x01\x02\x02\x12\x03E\x04\x15\x1a\xb1\x01\x20The\x20i'th\
    \x20exponential\x20bucket\x20covers\x20the\x20interval\n\x20\x20\x20[sca\
    le\x20*\x20growth_factor^(i-1),\x20scale\x20*\x20growth_factor^i)\n\x20w\
    here\x20i\x20ranges\x20from\x201\x20to\x20num_finite_buckets\x20inclusiv\
    e.\n\x20Must\x20be\x20>\x200.\n\n\x0f\n\x07\x04\0\x03\x01\x02\x02\x04\
    \x12\x04E\x04?\x1d\n\x0e\n\x07\x04\0\x03\x01\x02\x02\x05\x12\x03E\x04\n\
    \n\x0e\n\x07\x04\0\x03\x01\x02\x02\x01\x12\x03E\x0b\x10\n\x0e\n\x07\x04\
    \0\x03\x01\x02\x02\x03\x12\x03E\x13\x14\nF\n\x04\x04\0\x03\x02\x12\x04I\
    \x02Z\x03\x1a8\x20Describing\x20buckets\x20with\x20arbitrary\x20user-pro\
    vided\x20width.\n\n\x0c\n\x05\x04\0\x03\x02\x01\x12\x03I\n\x19\n\xec\x05\
    \n\x06\x04\0\x03\x02\x02\0\x12\x03Y\x04\x1f\x1a\xdc\x05\x20'bound'\x20is\
    \x20a\x20list\x20of\x20strictly\x20increasing\x20boundaries\x20between\n\
    \x20buckets.\x20Note\x20that\x20a\x20list\x20of\x20length\x20N-1\x20defi\
    nes\x20N\x20buckets\x20because\n\x20of\x20fenceposting.\x20See\x20commen\
    ts\x20on\x20`bucket_options`\x20for\x20details.\n\n\x20The\x20i'th\x20fi\
    nite\x20bucket\x20covers\x20the\x20interval\n\x20\x20\x20[bound[i-1],\
    \x20bound[i])\n\x20where\x20i\x20ranges\x20from\x201\x20to\x20bound_size\
    ()\x20-\x201.\x20Note\x20that\x20there\x20are\x20no\n\x20finite\x20bucke\
    ts\x20at\x20all\x20if\x20'bound'\x20only\x20contains\x20a\x20single\x20e\
    lement;\x20in\n\x20that\x20special\x20case\x20the\x20single\x20bound\x20\
    defines\x20the\x20boundary\x20between\x20the\n\x20underflow\x20and\x20ov\
    erflow\x20buckets.\n\n\x20bucket\x20number\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20lower\x20bound\x20\x20\
    \x20\x20upper\x20bound\n\x20\x20i\x20==\x200\x20(underflow)\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20-inf\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20bound[i]\n\x20\x200\x20<\x20i\x20<\x20bound_size()\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20bound[i-1]\x20\x20\x20\
    \x20\x20bound[i]\n\x20\x20i\x20==\x20bound_size()\x20(overflow)\x20\x20\
    \x20\x20bound[i-1]\x20\x20\x20\x20\x20+inf\n\n\x0e\n\x07\x04\0\x03\x02\
    \x02\0\x04\x12\x03Y\x04\x0c\n\x0e\n\x07\x04\0\x03\x02\x02\0\x05\x12\x03Y\
    \r\x13\n\x0e\n\x07\x04\0\x03\x02\x02\0\x01\x12\x03Y\x14\x1a\n\x0e\n\x07\
    \x04\0\x03\x02\x02\0\x03\x12\x03Y\x1d\x1e\nM\n\x04\x04\0\x02\0\x12\x03]\
    \x02\x12\x1a@\x20The\x20total\x20number\x20of\x20samples\x20in\x20the\
    \x20distribution.\x20Must\x20be\x20>=\x200.\n\n\r\n\x05\x04\0\x02\0\x04\
    \x12\x04]\x02Z\x03\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03]\x02\x07\n\x0c\n\
    \x05\x04\0\x02\0\x01\x12\x03]\x08\r\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03]\
    \x10\x11\nx\n\x04\x04\0\x02\x01\x12\x03a\x02\x12\x1ak\x20The\x20arithmet\
    ic\x20mean\x20of\x20the\x20samples\x20in\x20the\x20distribution.\x20If\
    \x20`count`\x20is\n\x20zero\x20then\x20this\x20field\x20must\x20be\x20ze\
    ro.\n\n\r\n\x05\x04\0\x02\x01\x04\x12\x04a\x02]\x12\n\x0c\n\x05\x04\0\
    \x02\x01\x05\x12\x03a\x02\x08\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03a\t\r\
    \n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03a\x10\x11\nS\n\x04\x04\0\x02\x02\
    \x12\x03d\x02\x15\x1aF\x20The\x20minimum\x20of\x20the\x20population\x20o\
    f\x20values.\x20Ignored\x20if\x20`count`\x20is\x20zero.\n\n\r\n\x05\x04\
    \0\x02\x02\x04\x12\x04d\x02a\x12\n\x0c\n\x05\x04\0\x02\x02\x05\x12\x03d\
    \x02\x08\n\x0c\n\x05\x04\0\x02\x02\x01\x12\x03d\t\x10\n\x0c\n\x05\x04\0\
    \x02\x02\x03\x12\x03d\x13\x14\nS\n\x04\x04\0\x02\x03\x12\x03g\x02\x15\
    \x1aF\x20The\x20maximum\x20of\x20the\x20population\x20of\x20values.\x20I\
    gnored\x20if\x20`count`\x20is\x20zero.\n\n\r\n\x05\x04\0\x02\x03\x04\x12\
    \x04g\x02d\x15\n\x0c\n\x05\x04\0\x02\x03\x05\x12\x03g\x02\x08\n\x0c\n\
    \x05\x04\0\x02\x03\x01\x12\x03g\t\x10\n\x0c\n\x05\x04\0\x02\x03\x03\x12\
    \x03g\x13\x14\n\xe0\x01\n\x04\x04\0\x02\x04\x12\x03m\x02&\x1a\xd2\x01\
    \x20The\x20sum\x20of\x20squared\x20deviations\x20from\x20the\x20mean:\n\
    \x20\x20\x20Sum[i=1..count]((x_i\x20-\x20mean)^2)\n\x20where\x20each\x20\
    x_i\x20is\x20a\x20sample\x20values.\x20If\x20`count`\x20is\x20zero\x20th\
    en\x20this\x20field\n\x20must\x20be\x20zero,\x20otherwise\x20validation\
    \x20of\x20the\x20request\x20fails.\n\n\r\n\x05\x04\0\x02\x04\x04\x12\x04\
    m\x02g\x15\n\x0c\n\x05\x04\0\x02\x04\x05\x12\x03m\x02\x08\n\x0c\n\x05\
    \x04\0\x02\x04\x01\x12\x03m\t!\n\x0c\n\x05\x04\0\x02\x04\x03\x12\x03m$%\
    \n\xb8\x04\n\x04\x04\0\x02\x05\x12\x03z\x02#\x1a\xaa\x04\x20The\x20numbe\
    r\x20of\x20samples\x20in\x20each\x20histogram\x20bucket.\x20`bucket_coun\
    ts`\x20are\n\x20optional.\x20If\x20present,\x20they\x20must\x20sum\x20to\
    \x20the\x20`count`\x20value.\n\n\x20The\x20buckets\x20are\x20defined\x20\
    below\x20in\x20`bucket_option`.\x20There\x20are\x20N\x20buckets.\n\x20`b\
    ucket_counts[0]`\x20is\x20the\x20number\x20of\x20samples\x20in\x20the\
    \x20underflow\x20bucket.\n\x20`bucket_counts[1]`\x20to\x20`bucket_counts\
    [N-1]`\x20are\x20the\x20numbers\x20of\x20samples\n\x20in\x20each\x20of\
    \x20the\x20finite\x20buckets.\x20And\x20`bucket_counts[N]\x20is\x20the\
    \x20number\n\x20of\x20samples\x20in\x20the\x20overflow\x20bucket.\x20See\
    \x20the\x20comments\x20of\x20`bucket_option`\n\x20below\x20for\x20more\
    \x20details.\n\n\x20Any\x20suffix\x20of\x20trailing\x20zeros\x20may\x20b\
    e\x20omitted.\n\n\x0c\n\x05\x04\0\x02\x05\x04\x12\x03z\x02\n\n\x0c\n\x05\
    \x04\0\x02\x05\x05\x12\x03z\x0b\x10\n\x0c\n\x05\x04\0\x02\x05\x01\x12\
    \x03z\x11\x1e\n\x0c\n\x05\x04\0\x02\x05\x03\x12\x03z!\"\n\xf2\x08\n\x04\
    \x04\0\x08\0\x12\x06\x93\x01\x02\x9c\x01\x03\x1a\xe1\x08\x20Defines\x20t\
    he\x20buckets\x20in\x20the\x20histogram.\x20`bucket_option`\x20and\x20`b\
    ucket_counts`\n\x20must\x20be\x20both\x20set,\x20or\x20both\x20unset.\n\
    \n\x20Buckets\x20are\x20numbered\x20in\x20the\x20range\x20of\x20[0,\x20N\
    ],\x20with\x20a\x20total\x20of\x20N+1\x20buckets.\n\x20There\x20must\x20\
    be\x20at\x20least\x20two\x20buckets\x20(a\x20single-bucket\x20histogram\
    \x20gives\n\x20no\x20information\x20that\x20isn't\x20already\x20provided\
    \x20by\x20`count`).\n\n\x20The\x20first\x20bucket\x20is\x20the\x20underf\
    low\x20bucket\x20which\x20has\x20a\x20lower\x20bound\n\x20of\x20-inf.\
    \x20The\x20last\x20bucket\x20is\x20the\x20overflow\x20bucket\x20which\
    \x20has\x20an\n\x20upper\x20bound\x20of\x20+inf.\x20All\x20other\x20buck\
    ets\x20(if\x20any)\x20are\x20called\x20\"finite\"\n\x20buckets\x20becaus\
    e\x20they\x20have\x20finite\x20lower\x20and\x20upper\x20bounds.\x20As\
    \x20described\n\x20below,\x20there\x20are\x20three\x20ways\x20to\x20defi\
    ne\x20the\x20finite\x20buckets.\n\n\x20\x20\x20(1)\x20Buckets\x20with\
    \x20constant\x20width.\n\x20\x20\x20(2)\x20Buckets\x20with\x20exponentia\
    lly\x20growing\x20widths.\n\x20\x20\x20(3)\x20Buckets\x20with\x20arbitra\
    ry\x20user-provided\x20widths.\n\n\x20In\x20all\x20cases,\x20the\x20buck\
    ets\x20cover\x20the\x20entire\x20real\x20number\x20line\x20(-inf,\n\x20+\
    inf).\x20Bucket\x20upper\x20bounds\x20are\x20exclusive\x20and\x20lower\
    \x20bounds\x20are\n\x20inclusive.\x20The\x20upper\x20bound\x20of\x20the\
    \x20underflow\x20bucket\x20is\x20equal\x20to\x20the\n\x20lower\x20bound\
    \x20of\x20the\x20smallest\x20finite\x20bucket;\x20the\x20lower\x20bound\
    \x20of\x20the\n\x20overflow\x20bucket\x20is\x20equal\x20to\x20the\x20upp\
    er\x20bound\x20of\x20the\x20largest\x20finite\n\x20bucket.\n\n\r\n\x05\
    \x04\0\x08\0\x01\x12\x04\x93\x01\x08\x15\n,\n\x04\x04\0\x02\x06\x12\x04\
    \x95\x01\x04%\x1a\x1e\x20Buckets\x20with\x20constant\x20width.\n\n\r\n\
    \x05\x04\0\x02\x06\x06\x12\x04\x95\x01\x04\x11\n\r\n\x05\x04\0\x02\x06\
    \x01\x12\x04\x95\x01\x12\x20\n\r\n\x05\x04\0\x02\x06\x03\x12\x04\x95\x01\
    #$\n9\n\x04\x04\0\x02\x07\x12\x04\x98\x01\x04/\x1a+\x20Buckets\x20with\
    \x20exponentially\x20growing\x20width.\n\n\r\n\x05\x04\0\x02\x07\x06\x12\
    \x04\x98\x01\x04\x16\n\r\n\x05\x04\0\x02\x07\x01\x12\x04\x98\x01\x17*\n\
    \r\n\x05\x04\0\x02\x07\x03\x12\x04\x98\x01-.\n;\n\x04\x04\0\x02\x08\x12\
    \x04\x9b\x01\x04)\x1a-\x20Buckets\x20with\x20arbitrary\x20user-provided\
    \x20width.\n\n\r\n\x05\x04\0\x02\x08\x06\x12\x04\x9b\x01\x04\x13\n\r\n\
    \x05\x04\0\x02\x08\x01\x12\x04\x9b\x01\x14$\n\r\n\x05\x04\0\x02\x08\x03\
    \x12\x04\x9b\x01'(b\x06proto3\
";
