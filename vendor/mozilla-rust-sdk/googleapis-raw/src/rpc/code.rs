...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\xcc\x02\n\x02\x05\0\x12\x05\x1f\0\xb9\x01\x01\x1a\xbe\x02\x20The\x20c\
    anonical\x20error\x20codes\x20for\x20gRPC\x20APIs.\n\n\n\x20Sometimes\
    ...
    \x05\0\x02\x02\x12\x031\x02\x0e\x1a\xcc\x02\x20Unknown\x20error.\x20\x20\
    ...
    \n\x92\x02\n\x04\x05\0\x02\x03\x12\x039\x02\x17\x1a\x84\x02\x20The\x20cl\
    ...
    \0\x02\x05\x12\x03M\x02\x10\x1a\x8c\x03\x20Some\x20requested\x20entity\
    ...
    \x12\x03M\x0e\x0f\n\x83\x01\n\x04\x05\0\x02\x06\x12\x03S\x02\x15\x1av\
    ...
    \x04\x05\0\x02\x07\x12\x03_\x02\x18\x1a\xeb\x03\x20The\x20caller\x20does\
    ...
    \x12\x03\x7f\x02\x1a\x1a\xca\x07\x20The\x20operation\x20was\x20rejected\
    \x20because\x20the\x20system\x20is\x20not\x20in\x20a\x20state\n\x20requi\
    red\x20for\x20the\x20operation's\x20execution.\x20\x20For\x20example,\
    ...
    \x02\n\x04\x05\0\x02\x0b\x12\x04\x88\x01\x02\x0f\x1a\xfd\x01\x20The\x20o\
    peration\x20was\x20aborted,\x20typically\x20due\x20to\x20a\x20concurrenc\
    y\x20issue\x20such\x20as\n\x20a\x20sequencer\x20check\x20failure\x20or\
    \x20transaction\x20abort.\n\n\x20See\x20the\x20guidelines\x20above\x20fo\
    r\x20deciding\x20between\x20`FAILED_PRECONDITION`,\n\x20`ABORTED`,\x20an\
    d\x20`UNAVAILABLE`.\n\n\x20HTTP\x20Mapping:\x20409\x20Conflict\n\n\r\n\
    \x05\x05\0\x02\x0b\x01\x12\x04\x88\x01\x02\t\n\r\n\x05\x05\0\x02\x0b\x02\
    \x12\x04\x88\x01\x0c\x0e\n\x85\x06\n\x04\x05\0\x02\x0c\x12\x04\x9b\x01\
    \x02\x14\x1a\xf6\x05\x20The\x20operation\x20was\x20attempted\x20past\x20\
    the\x20valid\x20range.\x20\x20E.g.,\x20seeking\x20or\n\x20reading\x20pas\
    t\x20end-of-file.\n\n\x20Unlike\x20`INVALID_ARGUMENT`,\x20this\x20error\
    \x20indicates\x20a\x20problem\x20that\x20may\n\x20be\x20fixed\x20if\x20t\
    he\x20system\x20state\x20changes.\x20For\x20example,\x20a\x2032-bit\x20f\
    ile\n\x20system\x20will\x20generate\x20`INVALID_ARGUMENT`\x20if\x20asked\
    \x20to\x20read\x20at\x20an\n\x20offset\x20that\x20is\x20not\x20in\x20the\
    \x20range\x20[0,2^32-1],\x20but\x20it\x20will\x20generate\n\x20`OUT_OF_R\
    ANGE`\x20if\x20asked\x20to\x20read\x20from\x20an\x20offset\x20past\x20th\
    e\x20current\n\x20file\x20size.\n\n\x20There\x20is\x20a\x20fair\x20bit\
    \x20of\x20overlap\x20between\x20`FAILED_PRECONDITION`\x20and\n\x20`OUT_O\
    F_RANGE`.\x20\x20We\x20recommend\x20using\x20`OUT_OF_RANGE`\x20(the\x20m\
    ore\x20specific\n\x20error)\x20when\x20it\x20applies\x20so\x20that\x20ca\
    llers\x20who\x20are\x20iterating\x20through\n\x20a\x20space\x20can\x20ea\
    sily\x20look\x20for\x20an\x20`OUT_OF_RANGE`\x20error\x20to\x20detect\x20\
    when\n\x20they\x20are\x20done.\n\n\x20HTTP\x20Mapping:\x20400\x20Bad\x20\
    Request\n\n\r\n\x05\x05\0\x02\x0c\x01\x12\x04\x9b\x01\x02\x0e\n\r\n\x05\
    \x05\0\x02\x0c\x02\x12\x04\x9b\x01\x11\x13\n\x82\x01\n\x04\x05\0\x02\r\
    \x12\x04\xa1\x01\x02\x15\x1at\x20The\x20operation\x20is\x20not\x20implem\
    ented\x20or\x20is\x20not\x20supported/enabled\x20in\x20this\n\x20service\
    .\n\n\x20HTTP\x20Mapping:\x20501\x20Not\x20Implemented\n\n\r\n\x05\x05\0\
    \x02\r\x01\x12\x04\xa1\x01\x02\x0f\n\r\n\x05\x05\0\x02\r\x02\x12\x04\xa1\
    \x01\x12\x14\n\xd3\x01\n\x04\x05\0\x02\x0e\x12\x04\xa8\x01\x02\x10\x1a\
    \xc4\x01\x20Internal\x20errors.\x20\x20This\x20means\x20that\x20some\x20\
    invariants\x20expected\x20by\x20the\n\x20underlying\x20system\x20have\
    \x20been\x20broken.\x20\x20This\x20error\x20code\x20is\x20reserved\n\x20\
    for\x20serious\x20errors.\n\n\x20HTTP\x20Mapping:\x20500\x20Internal\x20\
    Server\x20Error\n\n\r\n\x05\x05\0\x02\x0e\x01\x12\x04\xa8\x01\x02\n\n\r\
    \n\x05\x05\0\x02\x0e\x02\x12\x04\xa8\x01\r\x0f\n\xea\x02\n\x04\x05\0\x02\
    \x0f\x12\x04\xb3\x01\x02\x13\x1a\xdb\x02\x20The\x20service\x20is\x20curr\
    ently\x20unavailable.\x20\x20This\x20is\x20most\x20likely\x20a\n\x20tran\
    sient\x20condition,\x20which\x20can\x20be\x20corrected\x20by\x20retrying\
    \x20with\n\x20a\x20backoff.\x20Note\x20that\x20it\x20is\x20not\x20always\
    \x20safe\x20to\x20retry\n\x20non-idempotent\x20operations.\n\n\x20See\
    \x20the\x20guidelines\x20above\x20for\x20deciding\x20between\x20`FAILED_\
    PRECONDITION`,\n\x20`ABORTED`,\x20and\x20`UNAVAILABLE`.\n\n\x20HTTP\x20M\
    apping:\x20503\x20Service\x20Unavailable\n\n\r\n\x05\x05\0\x02\x0f\x01\
    \x12\x04\xb3\x01\x02\r\n\r\n\x05\x05\0\x02\x0f\x02\x12\x04\xb3\x01\x10\
    \x12\n`\n\x04\x05\0\x02\x10\x12\x04\xb8\x01\x02\x11\x1aR\x20Unrecoverabl\
    e\x20data\x20loss\x20or\x20corruption.\n\n\x20HTTP\x20Mapping:\x20500\
    \x20Internal\x20Server\x20Error\n\n\r\n\x05\x05\0\x02\x10\x01\x12\x04\
    \xb8\x01\x02\x0b\n\r\n\x05\x05\0\x02\x10\x02\x12\x04\xb8\x01\x0e\x10b\
    \x06proto3\
";
