...
const METHOD_OPERATIONS_WAIT_OPERATION: ::grpcio::Method<
    super::operations::WaitOperationRequest,
    super::operations::Operation,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
impl OperationsClient {
    ...
    pub fn wait_operation_opt(
        ...
        self.client
            .unary_call(&METHOD_OPERATIONS_WAIT_OPERATION, req, opt)
    }
    ...
    pub fn wait_operation_async_opt(
        ...
        self.client
            .unary_call_async(&METHOD_OPERATIONS_WAIT_OPERATION, req, opt)
    }
...
pub fn create_operations<S: Operations + Send + Clone + 'static>(s: S) -> ::grpcio::Service {
    ...
    let mut instance = s;
    builder = builder
        .add_unary_handler(&METHOD_OPERATIONS_WAIT_OPERATION, move |ctx, req, resp| {
