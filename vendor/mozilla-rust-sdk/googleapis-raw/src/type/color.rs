...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x04\0\x12\x06\x93\x01\0\xa9\x01\x01\x1a\xad\x1f\x20Represents\x20a\x20c\
    olor\x20in\x20the\x20RGBA\x20color\x20space.\x20This\x20representation\
    \x20is\x20designed\n\x20for\x20simplicity\x20of\x20conversion\x20to/from\
    \x20color\x20representations\x20in\x20various\n\x20languages\x20over\x20\
    compactness;\x20for\x20example,\x20the\x20fields\x20of\x20this\x20repres\
    entation\n\x20can\x20be\x20trivially\x20provided\x20to\x20the\x20constru\
    ctor\x20of\x20\"java.awt.Color\"\x20in\x20Java;\x20it\n\x20can\x20also\
    \x20be\x20trivially\x20provided\x20to\x20UIColor's\x20\"+colorWithRed:gr\
    een:blue:alpha\"\n\x20method\x20in\x20iOS;\x20and,\x20with\x20just\x20a\
    \x20little\x20work,\x20it\x20can\x20be\x20easily\x20formatted\x20into\n\
    \x20a\x20CSS\x20\"rgba()\"\x20string\x20in\x20JavaScript,\x20as\x20well.\
    \n\n\x20Note:\x20this\x20proto\x20does\x20not\x20carry\x20information\
    \x20about\x20the\x20absolute\x20color\x20space\n\x20that\x20should\x20be\
    \x20used\x20to\x20interpret\x20the\x20RGB\x20value\x20(e.g.\x20sRGB,\x20\
    Adobe\x20RGB,\n\x20DCI-P3,\x20BT.2020,\x20etc.).\x20By\x20default,\x20ap\
    plications\x20SHOULD\x20assume\x20the\x20sRGB\x20color\n\x20space.\n\n\
    \x20Example\x20(Java):\n\n\x20\x20\x20\x20\x20\x20import\x20com.google.t\
    ype.Color;\n\n\x20\x20\x20\x20\x20\x20//\x20...\n\x20\x20\x20\x20\x20\
    \x20public\x20static\x20java.awt.Color\x20fromProto(Color\x20protocolor)\
    \x20{\n\x20\x20\x20\x20\x20\x20\x20\x20float\x20alpha\x20=\x20protocolor\
    .hasAlpha()\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20?\x20protoc\
    olor.getAlpha().getValue()\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20:\x201.0;\n\n\x20\x20\x20\x20\x20\x20\x20\x20return\x20new\x20java.a\
    wt.Color(\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20protocolor.ge\
    tRed(),\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20protocolor.getG\
    reen(),\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20protocolor.getB\
    lue(),\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20alpha);\n\x20\
    \x20\x20\x20\x20\x20}\n\n\x20\x20\x20\x20\x20\x20public\x20static\x20Col\
    or\x20toProto(java.awt.Color\x20color)\x20{\n\x20\x20\x20\x20\x20\x20\
    \x20\x20float\x20red\x20=\x20(float)\x20color.getRed();\n\x20\x20\x20\
    \x20\x20\x20\x20\x20float\x20green\x20=\x20(float)\x20color.getGreen();\
    \n\x20\x20\x20\x20\x20\x20\x20\x20float\x20blue\x20=\x20(float)\x20color\
    .getBlue();\n\x20\x20\x20\x20\x20\x20\x20\x20float\x20denominator\x20=\
    \x20255.0;\n\x20\x20\x20\x20\x20\x20\x20\x20Color.Builder\x20resultBuild\
    er\x20=\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20Color\n\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20.newBuilder()\n\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20.setRed(\
    red\x20/\x20denominator)\n\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\
    \x20\x20\x20\x20\x20.setGreen(green\x20/\x20denominator)\n\x20\x20\x20\
    \x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20.setBlue(blue\x20/\
    \x20denominator);\n\x20\x20\x20\x20\x20\x20\x20\x20int\x20alpha\x20=\x20\
    ...
    \x12\x04\x95\x01\x02\x10\x1aC\x20The\x20amount\x20of\x20red\x20in\x20the\
    \x20color\x20as\x20a\x20value\x20in\x20the\x20interval\x20[0,\x201].\n\n\
    \x0f\n\x05\x04\0\x02\0\x04\x12\x06\x95\x01\x02\x93\x01\x0f\n\r\n\x05\x04\
    \0\x02\0\x05\x12\x04\x95\x01\x02\x07\n\r\n\x05\x04\0\x02\0\x01\x12\x04\
    \x95\x01\x08\x0b\n\r\n\x05\x04\0\x02\0\x03\x12\x04\x95\x01\x0e\x0f\nS\n\
    \x04\x04\0\x02\x01\x12\x04\x98\x01\x02\x12\x1aE\x20The\x20amount\x20of\
    \x20green\x20in\x20the\x20color\x20as\x20a\x20value\x20in\x20the\x20inte\
    rval\x20[0,\x201].\n\n\x0f\n\x05\x04\0\x02\x01\x04\x12\x06\x98\x01\x02\
    ...
    \x02\x04\x12\x06\x9b\x01\x02\x98\x01\x12\n\r\n\x05\x04\0\x02\x02\x05\x12\
    \x04\x9b\x01\x02\x07\n\r\n\x05\x04\0\x02\x02\x01\x12\x04\x9b\x01\x08\x0c\
    \n\r\n\x05\x04\0\x02\x02\x03\x12\x04\x9b\x01\x0f\x10\n\x81\x05\n\x04\x04\
    \0\x02\x03\x12\x04\xa8\x01\x02'\x1a\xf2\x04\x20The\x20fraction\x20of\x20\
