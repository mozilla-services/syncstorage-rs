...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \xca\x02\x17Google\\Cloud\\Spanner\\V1J\xcb\"\n\x06\x12\x04\x0f\0v\x01\n\
    ...
    \x04#\0M\x01\x1a\xcc\x02\x20`TypeCode`\x20is\x20used\x20as\x20part\x20of\
    \x20[Type][google.spanner.v1.Type]\x20to\n\x20indicate\x20the\x20type\
    \x20of\x20a\x20Cloud\x20Spanner\x20value.\n\n\x20Each\x20legal\x20value\
    \x20of\x20a\x20type\x20can\x20be\x20encoded\x20to\x20or\x20decoded\x20fr\
    om\x20a\x20JSON\n\x20value,\x20using\x20the\x20encodings\x20described\
    \x20below.\x20All\x20Cloud\x20Spanner\x20values\x20can\n\x20be\x20`null`\
    ,\x20regardless\x20of\x20type;\x20`null`s\x20are\x20always\x20encoded\
    \x20as\x20a\x20JSON\n\x20`null`.\n\n\n\n\x03\x05\0\x01\x12\x03#\x05\r\n\
    \x1d\n\x04\x05\0\x02\0\x12\x03%\x02\x1c\x1a\x10\x20Not\x20specified.\n\n\
    \x0c\n\x05\x05\0\x02\0\x01\x12\x03%\x02\x17\n\x0c\n\x05\x05\0\x02\0\x02\
    \x12\x03%\x1a\x1b\n1\n\x04\x05\0\x02\x01\x12\x03(\x02\x0b\x1a$\x20Encode\
    d\x20as\x20JSON\x20`true`\x20or\x20`false`.\n\n\x0c\n\x05\x05\0\x02\x01\
    \x01\x12\x03(\x02\x06\n\x0c\n\x05\x05\0\x02\x01\x02\x12\x03(\t\n\n6\n\
    \x04\x05\0\x02\x02\x12\x03+\x02\x0c\x1a)\x20Encoded\x20as\x20`string`,\
    \x20in\x20decimal\x20format.\n\n\x0c\n\x05\x05\0\x02\x02\x01\x12\x03+\
    \x02\x07\n\x0c\n\x05\x05\0\x02\x02\x02\x12\x03+\n\x0b\n\\\n\x04\x05\0\
    \x02\x03\x12\x03/\x02\x0e\x1aO\x20Encoded\x20as\x20`number`,\x20or\x20th\
    e\x20strings\x20`\"NaN\"`,\x20`\"Infinity\"`,\x20or\n\x20`\"-Infinity\"`\
    .\n\n\x0c\n\x05\x05\0\x02\x03\x01\x12\x03/\x02\t\n\x0c\n\x05\x05\0\x02\
    \x03\x02\x12\x03/\x0c\r\n\xdd\x02\n\x04\x05\0\x02\x04\x12\x039\x02\x10\
    \x1a\xcf\x02\x20Encoded\x20as\x20`string`\x20in\x20RFC\x203339\x20timest\
    amp\x20format.\x20The\x20time\x20zone\n\x20must\x20be\x20present,\x20and\
    \x20must\x20be\x20`\"Z\"`.\n\n\x20If\x20the\x20schema\x20has\x20the\x20c\
    olumn\x20option\n\x20`allow_commit_timestamp=true`,\x20the\x20placeholde\
    r\x20string\n\x20`\"spanner.commit_timestamp()\"`\x20can\x20be\x20used\
    \x20to\x20instruct\x20the\x20system\n\x20to\x20insert\x20the\x20commit\
    \x20timestamp\x20associated\x20with\x20the\x20transaction\n\x20commit.\n\
    \n\x0c\n\x05\x05\0\x02\x04\x01\x12\x039\x02\x0b\n\x0c\n\x05\x05\0\x02\
    \x04\x02\x12\x039\x0e\x0f\n;\n\x04\x05\0\x02\x05\x12\x03<\x02\x0b\x1a.\
    \x20Encoded\x20as\x20`string`\x20in\x20RFC\x203339\x20date\x20format.\n\
    \n\x0c\n\x05\x05\0\x02\x05\x01\x12\x03<\x02\x06\n\x0c\n\x05\x05\0\x02\
    \x05\x02\x12\x03<\t\n\n#\n\x04\x05\0\x02\x06\x12\x03?\x02\r\x1a\x16\x20E\
    ncoded\x20as\x20`string`.\n\n\x0c\n\x05\x05\0\x02\x06\x01\x12\x03?\x02\
    \x08\n\x0c\n\x05\x05\0\x02\x06\x02\x12\x03?\x0b\x0c\nZ\n\x04\x05\0\x02\
    \x07\x12\x03C\x02\x0c\x1aM\x20Encoded\x20as\x20a\x20base64-encoded\x20`s\
    tring`,\x20as\x20described\x20in\x20RFC\x204648,\n\x20section\x204.\n\n\
    \x0c\n\x05\x05\0\x02\x07\x01\x12\x03C\x02\x07\n\x0c\n\x05\x05\0\x02\x07\
    \x02\x12\x03C\n\x0b\n\x9a\x01\n\x04\x05\0\x02\x08\x12\x03H\x02\x0c\x1a\
    \x8c\x01\x20Encoded\x20as\x20`list`,\x20where\x20the\x20list\x20elements\
    \x20are\x20represented\n\x20according\x20to\n\x20[array_element_type][go\
    ogle.spanner.v1.Type.array_element_type].\n\n\x0c\n\x05\x05\0\x02\x08\
    \x01\x12\x03H\x02\x07\n\x0c\n\x05\x05\0\x02\x08\x02\x12\x03H\n\x0b\n\x94\
    \x01\n\x04\x05\0\x02\t\x12\x03L\x02\r\x1a\x86\x01\x20Encoded\x20as\x20`l\
    ...
    \t\x02\x12\x03L\x0b\x0c\n\x84\x01\n\x02\x04\0\x12\x04Q\0\\\x01\x1ax\x20`\
    Type`\x20indicates\x20the\x20type\x20of\x20a\x20Cloud\x20Spanner\x20valu\
    e,\x20as\x20might\x20be\x20stored\x20in\x20a\n\x20table\x20cell\x20or\
    \x20returned\x20from\x20an\x20SQL\x20query.\n\n\n\n\x03\x04\0\x01\x12\
    \x03Q\x08\x0c\nR\n\x04\x04\0\x02\0\x12\x03S\x02\x14\x1aE\x20Required.\
    \x20The\x20[TypeCode][google.spanner.v1.TypeCode]\x20for\x20this\x20type\
    .\n\n\r\n\x05\x04\0\x02\0\x04\x12\x04S\x02Q\x0e\n\x0c\n\x05\x04\0\x02\0\
    \x06\x12\x03S\x02\n\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03S\x0b\x0f\n\x0c\n\
    \x05\x04\0\x02\0\x03\x12\x03S\x12\x13\n\xa2\x01\n\x04\x04\0\x02\x01\x12\
    \x03W\x02\x1e\x1a\x94\x01\x20If\x20[code][google.spanner.v1.Type.code]\
    \x20==\x20[ARRAY][google.spanner.v1.TypeCode.ARRAY],\x20then\x20`array_e\
    lement_type`\n\x20is\x20the\x20type\x20of\x20the\x20array\x20elements.\n\
    \n\r\n\x05\x04\0\x02\x01\x04\x12\x04W\x02S\x14\n\x0c\n\x05\x04\0\x02\x01\
    \x06\x12\x03W\x02\x06\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03W\x07\x19\n\
    \x0c\n\x05\x04\0\x02\x01\x03\x12\x03W\x1c\x1d\n\xad\x01\n\x04\x04\0\x02\
    \x02\x12\x03[\x02\x1d\x1a\x9f\x01\x20If\x20[code][google.spanner.v1.Type\
    .code]\x20==\x20[STRUCT][google.spanner.v1.TypeCode.STRUCT],\x20then\x20\
    `struct_type`\n\x20provides\x20type\x20information\x20for\x20the\x20stru\
    ct's\x20fields.\n\n\r\n\x05\x04\0\x02\x02\x04\x12\x04[\x02W\x1e\n\x0c\n\
    \x05\x04\0\x02\x02\x06\x12\x03[\x02\x0c\n\x0c\n\x05\x04\0\x02\x02\x01\
    \x12\x03[\r\x18\n\x0c\n\x05\x04\0\x02\x02\x03\x12\x03[\x1b\x1c\nd\n\x02\
    \x04\x01\x12\x04_\0v\x01\x1aX\x20`StructType`\x20defines\x20the\x20field\
    s\x20of\x20a\x20[STRUCT][google.spanner.v1.TypeCode.STRUCT]\x20type.\n\n\
    \n\n\x03\x04\x01\x01\x12\x03_\x08\x12\n@\n\x04\x04\x01\x03\0\x12\x04a\
    \x02m\x03\x1a2\x20Message\x20representing\x20a\x20single\x20field\x20of\
    \x20a\x20struct.\n\n\x0c\n\x05\x04\x01\x03\0\x01\x12\x03a\n\x0f\n\x99\
    \x03\n\x06\x04\x01\x03\0\x02\0\x12\x03i\x04\x14\x1a\x89\x03\x20The\x20na\
    me\x20of\x20the\x20field.\x20For\x20reads,\x20this\x20is\x20the\x20colum\
    n\x20name.\x20For\n\x20SQL\x20queries,\x20it\x20is\x20the\x20column\x20a\
    lias\x20(e.g.,\x20`\"Word\"`\x20in\x20the\n\x20query\x20`\"SELECT\x20'he\
    llo'\x20AS\x20Word\"`),\x20or\x20the\x20column\x20name\x20(e.g.,\n\x20`\
    \"ColName\"`\x20in\x20the\x20query\x20`\"SELECT\x20ColName\x20FROM\x20Ta\
    ble\"`).\x20Some\n\x20columns\x20might\x20have\x20an\x20empty\x20name\
    \x20(e.g.,\x20!\"SELECT\n\x20UPPER(ColName)\"`).\x20Note\x20that\x20a\
    \x20query\x20result\x20can\x20contain\n\x20multiple\x20fields\x20with\
    \x20the\x20same\x20name.\n\n\x0f\n\x07\x04\x01\x03\0\x02\0\x04\x12\x04i\
    \x04a\x11\n\x0e\n\x07\x04\x01\x03\0\x02\0\x05\x12\x03i\x04\n\n\x0e\n\x07\
    \x04\x01\x03\0\x02\0\x01\x12\x03i\x0b\x0f\n\x0e\n\x07\x04\x01\x03\0\x02\
    \0\x03\x12\x03i\x12\x13\n'\n\x06\x04\x01\x03\0\x02\x01\x12\x03l\x04\x12\
    \x1a\x18\x20The\x20type\x20of\x20the\x20field.\n\n\x0f\n\x07\x04\x01\x03\
    \0\x02\x01\x04\x12\x04l\x04i\x14\n\x0e\n\x07\x04\x01\x03\0\x02\x01\x06\
    \x12\x03l\x04\x08\n\x0e\n\x07\x04\x01\x03\0\x02\x01\x01\x12\x03l\t\r\n\
    \x0e\n\x07\x04\x01\x03\0\x02\x01\x03\x12\x03l\x10\x11\n\x8a\x03\n\x04\
    \x04\x01\x02\0\x12\x03u\x02\x1c\x1a\xfc\x02\x20The\x20list\x20of\x20fiel\
    ds\x20that\x20make\x20up\x20this\x20struct.\x20Order\x20is\n\x20signific\
    ant,\x20because\x20values\x20of\x20this\x20struct\x20type\x20are\x20repr\
    esented\x20as\n\x20lists,\x20where\x20the\x20order\x20of\x20field\x20val\
    ues\x20matches\x20the\x20order\x20of\n\x20fields\x20in\x20the\x20[Struct\
    Type][google.spanner.v1.StructType].\x20In\x20turn,\x20the\x20order\x20o\
    f\x20fields\n\x20matches\x20the\x20order\x20of\x20columns\x20in\x20a\x20\
    read\x20request,\x20or\x20the\x20order\x20of\n\x20fields\x20in\x20the\
    \x20`SELECT`\x20clause\x20of\x20a\x20query.\n\n\x0c\n\x05\x04\x01\x02\0\
    \x04\x12\x03u\x02\n\n\x0c\n\x05\x04\x01\x02\0\x06\x12\x03u\x0b\x10\n\x0c\
    \n\x05\x04\x01\x02\0\x01\x12\x03u\x11\x17\n\x0c\n\x05\x04\x01\x02\0\x03\
    \x12\x03u\x1a\x1bb\x06proto3\
";
