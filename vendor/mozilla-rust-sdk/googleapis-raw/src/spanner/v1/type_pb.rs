...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x17.google.spanner.v1.TypeR\x04type*\x9b\x01\n\x08TypeCode\x12\x19\n\
    ...
    IC\x10\nB\xaf\x01\n\x15com.google.spanner.v1B\tTypeProtoP\x01Z8google.go\
    lang.org/genproto/googleapis/spanner/v1;spanner\xaa\x02\x17Google.Cloud.\
    Spanner.V1\xca\x02\x17Google\\Cloud\\Spanner\\V1\xea\x02\x1aGoogle::Clou\
    ...
    \x04\0\x12\x04\x1f\0*\x01\x1ax\x20`Type`\x20indicates\x20the\x20type\x20\
    of\x20a\x20Cloud\x20Spanner\x20value,\x20as\x20might\x20be\x20stored\x20\
    in\x20a\n\x20table\x20cell\x20or\x20returned\x20from\x20an\x20SQL\x20que\
    ry.\n\n\n\n\x03\x04\0\x01\x12\x03\x1f\x08\x0c\nR\n\x04\x04\0\x02\0\x12\
    \x03!\x02=\x1aE\x20Required.\x20The\x20[TypeCode][google.spanner.v1.Type\
    Code]\x20for\x20this\x20type.\n\n\r\n\x05\x04\0\x02\0\x04\x12\x04!\x02\
    ...
    \0D\x01\x1aX\x20`StructType`\x20defines\x20the\x20fields\x20of\x20a\x20[\
    STRUCT][google.spanner.v1.TypeCode.STRUCT]\x20type.\n\n\n\n\x03\x04\x01\
    \x01\x12\x03-\x08\x12\n@\n\x04\x04\x01\x03\0\x12\x04/\x02;\x03\x1a2\x20M\
    essage\x20representing\x20a\x20single\x20field\x20of\x20a\x20struct.\n\n\
    \x0c\n\x05\x04\x01\x03\0\x01\x12\x03/\n\x0f\n\x99\x03\n\x06\x04\x01\x03\
    \0\x02\0\x12\x037\x04\x14\x1a\x89\x03\x20The\x20name\x20of\x20the\x20fie\
    ld.\x20For\x20reads,\x20this\x20is\x20the\x20column\x20name.\x20For\n\
    \x20SQL\x20queries,\x20it\x20is\x20the\x20column\x20alias\x20(e.g.,\x20`\
    \"Word\"`\x20in\x20the\n\x20query\x20`\"SELECT\x20'hello'\x20AS\x20Word\
    \"`),\x20or\x20the\x20column\x20name\x20(e.g.,\n\x20`\"ColName\"`\x20in\
    \x20the\x20query\x20`\"SELECT\x20ColName\x20FROM\x20Table\"`).\x20Some\n\
    \x20columns\x20might\x20have\x20an\x20empty\x20name\x20(e.g.,\x20`\"SELE\
    CT\n\x20UPPER(ColName)\"`).\x20Note\x20that\x20a\x20query\x20result\x20c\
    an\x20contain\n\x20multiple\x20fields\x20with\x20the\x20same\x20name.\n\
    \n\x0f\n\x07\x04\x01\x03\0\x02\0\x04\x12\x047\x04/\x11\n\x0e\n\x07\x04\
    \x01\x03\0\x02\0\x05\x12\x037\x04\n\n\x0e\n\x07\x04\x01\x03\0\x02\0\x01\
    \x12\x037\x0b\x0f\n\x0e\n\x07\x04\x01\x03\0\x02\0\x03\x12\x037\x12\x13\n\
    '\n\x06\x04\x01\x03\0\x02\x01\x12\x03:\x04\x12\x1a\x18\x20The\x20type\
    ...
    v1.StructType].\x20In\x20turn,\x20the\x20order\x20of\x20fields\n\x20matc\
    hes\x20the\x20order\x20of\x20columns\x20in\x20a\x20read\x20request,\x20o\
    r\x20the\x20order\x20of\n\x20fields\x20in\x20the\x20`SELECT`\x20clause\
    ...
    \xda\x02\n\x02\x05\0\x12\x05M\0\x82\x01\x01\x1a\xcc\x02\x20`TypeCode`\
    ...
    \0\x01\x12\x03M\x05\r\n\x1d\n\x04\x05\0\x02\0\x12\x03O\x02\x1c\x1a\x10\
    \x20Not\x20specified.\n\n\x0c\n\x05\x05\0\x02\0\x01\x12\x03O\x02\x17\n\
    \x0c\n\x05\x05\0\x02\0\x02\x12\x03O\x1a\x1b\n1\n\x04\x05\0\x02\x01\x12\
    \x03R\x02\x0b\x1a$\x20Encoded\x20as\x20JSON\x20`true`\x20or\x20`false`.\
    \n\n\x0c\n\x05\x05\0\x02\x01\x01\x12\x03R\x02\x06\n\x0c\n\x05\x05\0\x02\
    \x01\x02\x12\x03R\t\n\n6\n\x04\x05\0\x02\x02\x12\x03U\x02\x0c\x1a)\x20En\
    coded\x20as\x20`string`,\x20in\x20decimal\x20format.\n\n\x0c\n\x05\x05\0\
    \x02\x02\x01\x12\x03U\x02\x07\n\x0c\n\x05\x05\0\x02\x02\x02\x12\x03U\n\
    \x0b\n\\\n\x04\x05\0\x02\x03\x12\x03Y\x02\x0e\x1aO\x20Encoded\x20as\x20`\
    ...
    \x04\x12\x03c\x02\x10\x1a\xcf\x02\x20Encoded\x20as\x20`string`\x20in\x20\
    RFC\x203339\x20timestamp\x20format.\x20The\x20time\x20zone\n\x20must\x20\
    be\x20present,\x20and\x20must\x20be\x20`\"Z\"`.\n\n\x20If\x20the\x20sche\
    ma\x20has\x20the\x20column\x20option\n\x20`allow_commit_timestamp=true`,\
    \x20the\x20placeholder\x20string\n\x20`\"spanner.commit_timestamp()\"`\
    \x20can\x20be\x20used\x20to\x20instruct\x20the\x20system\n\x20to\x20inse\
    rt\x20the\x20commit\x20timestamp\x20associated\x20with\x20the\x20transac\
    tion\n\x20commit.\n\n\x0c\n\x05\x05\0\x02\x04\x01\x12\x03c\x02\x0b\n\x0c\
    \n\x05\x05\0\x02\x04\x02\x12\x03c\x0e\x0f\n;\n\x04\x05\0\x02\x05\x12\x03\
    f\x02\x0b\x1a.\x20Encoded\x20as\x20`string`\x20in\x20RFC\x203339\x20date\
    \x20format.\n\n\x0c\n\x05\x05\0\x02\x05\x01\x12\x03f\x02\x06\n\x0c\n\x05\
    \x05\0\x02\x05\x02\x12\x03f\t\n\n#\n\x04\x05\0\x02\x06\x12\x03i\x02\r\
    \x1a\x16\x20Encoded\x20as\x20`string`.\n\n\x0c\n\x05\x05\0\x02\x06\x01\
    \x12\x03i\x02\x08\n\x0c\n\x05\x05\0\x02\x06\x02\x12\x03i\x0b\x0c\nZ\n\
    \x04\x05\0\x02\x07\x12\x03m\x02\x0c\x1aM\x20Encoded\x20as\x20a\x20base64\
    -encoded\x20`string`,\x20as\x20described\x20in\x20RFC\x204648,\n\x20sect\
    ion\x204.\n\n\x0c\n\x05\x05\0\x02\x07\x01\x12\x03m\x02\x07\n\x0c\n\x05\
    \x05\0\x02\x07\x02\x12\x03m\n\x0b\n\x9a\x01\n\x04\x05\0\x02\x08\x12\x03r\
    \x02\x0c\x1a\x8c\x01\x20Encoded\x20as\x20`list`,\x20where\x20the\x20list\
    \x20elements\x20are\x20represented\n\x20according\x20to\n\x20[array_elem\
    ent_type][google.spanner.v1.Type.array_element_type].\n\n\x0c\n\x05\x05\
    \0\x02\x08\x01\x12\x03r\x02\x07\n\x0c\n\x05\x05\0\x02\x08\x02\x12\x03r\n\
    \x0b\n\x94\x01\n\x04\x05\0\x02\t\x12\x03v\x02\r\x1a\x86\x01\x20Encoded\
    \x20as\x20`list`,\x20where\x20list\x20element\x20`i`\x20is\x20represente\
    d\x20according\n\x20to\x20[struct_type.fields[i]][google.spanner.v1.Stru\
    ctType.fields].\n\n\x0c\n\x05\x05\0\x02\t\x01\x12\x03v\x02\x08\n\x0c\n\
    \x05\x05\0\x02\t\x02\x12\x03v\x0b\x0c\n\xdd\x02\n\x04\x05\0\x02\n\x12\
    \x04\x81\x01\x02\x0f\x1a\xce\x02\x20Encoded\x20as\x20`string`,\x20in\x20\
    decimal\x20format\x20or\x20scientific\x20notation\x20format.\n\x20<br>De\
    cimal\x20format:\n\x20<br>`[+-]Digits[.[Digits]]`\x20or\n\x20<br>`[+-][D\
    igits].Digits`\n\n\x20Scientific\x20notation:\n\x20<br>`[+-]Digits[.[Dig\
    its]][ExponentIndicator[+-]Digits]`\x20or\n\x20<br>`[+-][Digits].Digits[\
    ExponentIndicator[+-]Digits]`\n\x20<br>(ExponentIndicator\x20is\x20`\"e\
    \"`\x20or\x20`\"E\"`)\n\n\r\n\x05\x05\0\x02\n\x01\x12\x04\x81\x01\x02\t\
    \n\r\n\x05\x05\0\x02\n\x02\x12\x04\x81\x01\x0c\x0eb\x06proto3\
";
