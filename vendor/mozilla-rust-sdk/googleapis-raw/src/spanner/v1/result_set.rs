...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    gle.Cloud.Spanner.V1\xca\x02\x17Google\\Cloud\\Spanner\\V1\xea\x02\x1aGo\
    ogle::Cloud::Spanner::V1J\xe5@\n\x07\x12\x05\x0e\0\xcc\x01\x01\n\xbc\x04\
    ...
    \x12\x03\x1f\03\ny\n\x02\x04\0\x12\x04#\08\x01\x1am\x20Results\x20from\
    \x20[Read][google.spanner.v1.Spanner.Read]\x20or\n\x20[ExecuteSql][googl\
    e.spanner.v1.Spanner.ExecuteSql].\n\n\n\n\x03\x04\0\x01\x12\x03#\x08\x11\
    \nK\n\x04\x04\0\x02\0\x12\x03%\x02!\x1a>\x20Metadata\x20about\x20the\x20\
    result\x20set,\x20such\x20as\x20row\x20type\x20information.\n\n\r\n\x05\
    \x04\0\x02\0\x04\x12\x04%\x02#\x13\n\x0c\n\x05\x04\0\x02\0\x06\x12\x03%\
    \x02\x13\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03%\x14\x1c\n\x0c\n\x05\x04\0\
    \x02\0\x03\x12\x03%\x1f\x20\n\xde\x02\n\x04\x04\0\x02\x01\x12\x03-\x02.\
    \x1a\xd0\x02\x20Each\x20element\x20in\x20`rows`\x20is\x20a\x20row\x20who\
    se\x20format\x20is\x20defined\x20by\n\x20[metadata.row_type][google.span\
    ner.v1.ResultSetMetadata.row_type].\x20The\x20ith\x20element\n\x20in\x20\
    each\x20row\x20matches\x20the\x20ith\x20field\x20in\n\x20[metadata.row_t\
    ype][google.spanner.v1.ResultSetMetadata.row_type].\x20Elements\x20are\n\
    \x20encoded\x20based\x20on\x20type\x20as\x20described\n\x20[here][google\
    .spanner.v1.TypeCode].\n\n\x0c\n\x05\x04\0\x02\x01\x04\x12\x03-\x02\n\n\
    \x0c\n\x05\x04\0\x02\x01\x06\x12\x03-\x0b$\n\x0c\n\x05\x04\0\x02\x01\x01\
    \x12\x03-%)\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03-,-\n\xf5\x04\n\x04\x04\
    \0\x02\x02\x12\x037\x02\x1b\x1a\xe7\x04\x20Query\x20plan\x20and\x20execu\
    tion\x20statistics\x20for\x20the\x20SQL\x20statement\x20that\n\x20produc\
    ed\x20this\x20result\x20set.\x20These\x20can\x20be\x20requested\x20by\
    \x20setting\n\x20[ExecuteSqlRequest.query_mode][google.spanner.v1.Execut\
    eSqlRequest.query_mode].\n\x20DML\x20statements\x20always\x20produce\x20\
    stats\x20containing\x20the\x20number\x20of\x20rows\n\x20modified,\x20unl\
    ess\x20executed\x20using\x20the\n\x20[ExecuteSqlRequest.QueryMode.PLAN][\
    google.spanner.v1.ExecuteSqlRequest.QueryMode.PLAN]\x20[ExecuteSqlReques\
    t.query_mode][google.spanner.v1.ExecuteSqlRequest.query_mode].\n\x20Othe\
    r\x20fields\x20may\x20or\x20may\x20not\x20be\x20populated,\x20based\x20o\
    n\x20the\n\x20[ExecuteSqlRequest.query_mode][google.spanner.v1.ExecuteSq\
