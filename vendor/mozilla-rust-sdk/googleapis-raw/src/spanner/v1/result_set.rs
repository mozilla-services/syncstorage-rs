...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \ny\n\x02\x04\0\x12\x04#\08\x01\x1am\x20Results\x20from\x20[Read][google\
    .spanner.v1.Spanner.Read]\x20or\n\x20[ExecuteSql][google.spanner.v1.Span\
    ner.ExecuteSql].\n\n\n\n\x03\x04\0\x01\x12\x03#\x08\x11\nK\n\x04\x04\0\
    \x02\0\x12\x03%\x02!\x1a>\x20Metadata\x20about\x20the\x20result\x20set,\
    \x20such\x20as\x20row\x20type\x20information.\n\n\r\n\x05\x04\0\x02\0\
    \x04\x12\x04%\x02#\x13\n\x0c\n\x05\x04\0\x02\0\x06\x12\x03%\x02\x13\n\
    \x0c\n\x05\x04\0\x02\0\x01\x12\x03%\x14\x1c\n\x0c\n\x05\x04\0\x02\0\x03\
    \x12\x03%\x1f\x20\n\xde\x02\n\x04\x04\0\x02\x01\x12\x03-\x02.\x1a\xd0\
    \x02\x20Each\x20element\x20in\x20`rows`\x20is\x20a\x20row\x20whose\x20fo\
    rmat\x20is\x20defined\x20by\n\x20[metadata.row_type][google.spanner.v1.R\
    esultSetMetadata.row_type].\x20The\x20ith\x20element\n\x20in\x20each\x20\
    row\x20matches\x20the\x20ith\x20field\x20in\n\x20[metadata.row_type][goo\
    gle.spanner.v1.ResultSetMetadata.row_type].\x20Elements\x20are\n\x20enco\
    ded\x20based\x20on\x20type\x20as\x20described\n\x20[here][google.spanner\
    .v1.TypeCode].\n\n\x0c\n\x05\x04\0\x02\x01\x04\x12\x03-\x02\n\n\x0c\n\
    \x05\x04\0\x02\x01\x06\x12\x03-\x0b$\n\x0c\n\x05\x04\0\x02\x01\x01\x12\
    \x03-%)\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03-,-\n\xf5\x04\n\x04\x04\0\
    \x02\x02\x12\x037\x02\x1b\x1a\xe7\x04\x20Query\x20plan\x20and\x20executi\
    on\x20statistics\x20for\x20the\x20SQL\x20statement\x20that\n\x20produced\
    \x20this\x20result\x20set.\x20These\x20can\x20be\x20requested\x20by\x20s\
    etting\n\x20[ExecuteSqlRequest.query_mode][google.spanner.v1.ExecuteSqlR\
    equest.query_mode].\n\x20DML\x20statements\x20always\x20produce\x20stats\
    \x20containing\x20the\x20number\x20of\x20rows\n\x20modified,\x20unless\
    \x20executed\x20using\x20the\n\x20[ExecuteSqlRequest.QueryMode.PLAN][goo\
    gle.spanner.v1.ExecuteSqlRequest.QueryMode.PLAN]\x20[ExecuteSqlRequest.q\
    uery_mode][google.spanner.v1.ExecuteSqlRequest.query_mode].\n\x20Other\
    \x20fields\x20may\x20or\x20may\x20not\x20be\x20populated,\x20based\x20on\
    ...
    \x01\n\x02\x04\x01\x12\x05=\0\xa0\x01\x01\x1a\xbe\x01\x20Partial\x20resu\
    lts\x20from\x20a\x20streaming\x20read\x20or\x20SQL\x20query.\x20Streamin\
    g\x20reads\x20and\n\x20SQL\x20queries\x20better\x20tolerate\x20large\x20\
    result\x20sets,\x20large\x20rows,\x20and\x20large\n\x20values,\x20but\
    \x20are\x20a\x20little\x20trickier\x20to\x20consume.\n\n\n\n\x03\x04\x01\
    \x01\x12\x03=\x08\x18\np\n\x04\x04\x01\x02\0\x12\x03@\x02!\x1ac\x20Metad\
    ...
    \x04\x01\x02\x02\x05\x12\x04\x90\x01\x02\x06\n\r\n\x05\x04\x01\x02\x02\
    \x01\x12\x04\x90\x01\x07\x14\n\r\n\x05\x04\x01\x02\x02\x03\x12\x04\x90\
    \x01\x17\x18\n\xbb\x02\n\x04\x04\x01\x02\x03\x12\x04\x97\x01\x02\x19\x1a\
    \xac\x02\x20Streaming\x20calls\x20might\x20be\x20interrupted\x20for\x20a\
    \x20variety\x20of\x20reasons,\x20such\n\x20as\x20TCP\x20connection\x20lo\
    ss.\x20If\x20this\x20occurs,\x20the\x20stream\x20of\x20results\x20can\n\
    \x20be\x20resumed\x20by\x20re-sending\x20the\x20original\x20request\x20a\
    nd\x20including\n\x20`resume_token`.\x20Note\x20that\x20executing\x20any\
    \x20other\x20transaction\x20in\x20the\n\x20same\x20session\x20invalidate\
    s\x20the\x20token.\n\n\x0f\n\x05\x04\x01\x02\x03\x04\x12\x06\x97\x01\x02\
    \x90\x01\x19\n\r\n\x05\x04\x01\x02\x03\x05\x12\x04\x97\x01\x02\x07\n\r\n\
    \x05\x04\x01\x02\x03\x01\x12\x04\x97\x01\x08\x14\n\r\n\x05\x04\x01\x02\
    \x03\x03\x12\x04\x97\x01\x17\x18\n\xeb\x02\n\x04\x04\x01\x02\x04\x12\x04\
    \x9f\x01\x02\x1b\x1a\xdc\x02\x20Query\x20plan\x20and\x20execution\x20sta\
    tistics\x20for\x20the\x20statement\x20that\x20produced\x20this\n\x20stre\
    aming\x20result\x20set.\x20These\x20can\x20be\x20requested\x20by\x20sett\
    ing\n\x20[ExecuteSqlRequest.query_mode][google.spanner.v1.ExecuteSqlRequ\
    est.query_mode]\x20and\x20are\x20sent\n\x20only\x20once\x20with\x20the\
    \x20last\x20response\x20in\x20the\x20stream.\n\x20This\x20field\x20will\
    \x20also\x20be\x20present\x20in\x20the\x20last\x20response\x20for\x20DML\
    \n\x20statements.\n\n\x0f\n\x05\x04\x01\x02\x04\x04\x12\x06\x9f\x01\x02\
    \x97\x01\x19\n\r\n\x05\x04\x01\x02\x04\x06\x12\x04\x9f\x01\x02\x10\n\r\n\
    \x05\x04\x01\x02\x04\x01\x12\x04\x9f\x01\x11\x16\n\r\n\x05\x04\x01\x02\
    \x04\x03\x12\x04\x9f\x01\x19\x1a\n\x84\x01\n\x02\x04\x02\x12\x06\xa3\x01\
    \0\xb1\x01\x01\x1av\x20Metadata\x20about\x20a\x20[ResultSet][google.span\
    ner.v1.ResultSet]\x20or\x20[PartialResultSet][google.spanner.v1.PartialR\
    esultSet].\n\n\x0b\n\x03\x04\x02\x01\x12\x04\xa3\x01\x08\x19\n\xd2\x02\n\
    \x04\x04\x02\x02\0\x12\x04\xac\x01\x02\x1a\x1a\xc3\x02\x20Indicates\x20t\
    he\x20field\x20names\x20and\x20types\x20for\x20the\x20rows\x20in\x20the\
