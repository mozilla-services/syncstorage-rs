...
impl ::protobuf::Message for Mutation_Write {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<Mutation_Write>(
                    "Mutation_Write",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static Mutation_Write {
        static mut instance: ::protobuf::lazy::Lazy<Mutation_Write> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const Mutation_Write,
        };
        unsafe {
...
impl ::protobuf::Message for Mutation_Delete {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                ::protobuf::reflect::MessageDescriptor::new::<Mutation_Delete>(
                    "Mutation_Delete",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static Mutation_Delete {
        static mut instance: ::protobuf::lazy::Lazy<Mutation_Delete> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const Mutation_Delete,
        };
        unsafe {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    le.Cloud.Spanner.V1\xca\x02\x17Google\\Cloud\\Spanner\\V1J\xf1\x1f\n\x06\
    ...
    \x20\x1a\xf2\x01\x20The\x20names\x20of\x20the\x20columns\x20in\x20[table\
    ][google.spanner.v1.Mutation.Write.table]\x20to\x20be\x20written.\n\n\
    \x20The\x20list\x20of\x20columns\x20must\x20contain\x20enough\x20columns\
    \x20to\x20allow\n\x20Cloud\x20Spanner\x20to\x20derive\x20values\x20for\
    \x20all\x20primary\x20key\x20columns\x20in\x20the\n\x20row(s)\x20to\x20b\
    e\x20modified.\n\n\x0e\n\x07\x04\0\x03\0\x02\x01\x04\x12\x03-\x04\x0c\n\
    \x0e\n\x07\x04\0\x03\0\x02\x01\x05\x12\x03-\r\x13\n\x0e\n\x07\x04\0\x03\
    \0\x02\x01\x01\x12\x03-\x14\x1b\n\x0e\n\x07\x04\0\x03\0\x02\x01\x03\x12\
    \x03-\x1e\x1f\n\xf8\x04\n\x06\x04\0\x03\0\x02\x02\x12\x037\x042\x1a\xe8\
    \x04\x20The\x20values\x20to\x20be\x20written.\x20`values`\x20can\x20cont\
    ain\x20more\x20than\x20one\n\x20list\x20of\x20values.\x20If\x20it\x20doe\
    s,\x20then\x20multiple\x20rows\x20are\x20written,\x20one\n\x20for\x20eac\
    h\x20entry\x20in\x20`values`.\x20Each\x20list\x20in\x20`values`\x20must\
    \x20have\n\x20exactly\x20as\x20many\x20entries\x20as\x20there\x20are\x20\
    entries\x20in\x20[columns][google.spanner.v1.Mutation.Write.columns]\n\
    \x20above.\x20Sending\x20multiple\x20lists\x20is\x20equivalent\x20to\x20\
    sending\x20multiple\n\x20`Mutation`s,\x20each\x20containing\x20one\x20`v\
    alues`\x20entry\x20and\x20repeating\n\x20[table][google.spanner.v1.Mutat\
    ion.Write.table]\x20and\x20[columns][google.spanner.v1.Mutation.Write.co\
    lumns].\x20Individual\x20values\x20in\x20each\x20list\x20are\n\x20encode\
    d\x20as\x20described\x20[here][google.spanner.v1.TypeCode].\n\n\x0e\n\
    \x07\x04\0\x03\0\x02\x02\x04\x12\x037\x04\x0c\n\x0e\n\x07\x04\0\x03\0\
    \x02\x02\x06\x12\x037\r&\n\x0e\n\x07\x04\0\x03\0\x02\x02\x01\x12\x037'-\
    \n\x0e\n\x07\x04\0\x03\0\x02\x02\x03\x12\x03701\nT\n\x04\x04\0\x03\x01\
    \x12\x04;\x02C\x03\x1aF\x20Arguments\x20to\x20[delete][google.spanner.v1\
    .Mutation.delete]\x20operations.\n\n\x0c\n\x05\x04\0\x03\x01\x01\x12\x03\
    ;\n\x10\n@\n\x06\x04\0\x03\x01\x02\0\x12\x03=\x04\x15\x1a1\x20Required.\
    \x20The\x20table\x20whose\x20rows\x20will\x20be\x20deleted.\n\n\x0f\n\
    ...
    \n\x06\x04\0\x03\x01\x02\x01\x12\x03B\x04\x17\x1a\xc7\x01\x20Required.\
    \x20The\x20primary\x20keys\x20of\x20the\x20rows\x20within\x20[table][goo\
    gle.spanner.v1.Mutation.Delete.table]\x20to\x20delete.\n\x20Delete\x20is\
    \x20idempotent.\x20The\x20transaction\x20will\x20succeed\x20even\x20if\
    \x20some\x20or\x20all\n\x20rows\x20do\x20not\x20exist.\n\n\x0f\n\x07\x04\
    \0\x03\x01\x02\x01\x04\x12\x04B\x04=\x15\n\x0e\n\x07\x04\0\x03\x01\x02\
    \x01\x06\x12\x03B\x04\n\n\x0e\n\x07\x04\0\x03\x01\x02\x01\x01\x12\x03B\
    \x0b\x12\n\x0e\n\x07\x04\0\x03\x01\x02\x01\x03\x12\x03B\x15\x16\n3\n\x04\
    \x04\0\x08\0\x12\x04F\x02]\x03\x1a%\x20Required.\x20The\x20operation\x20\
    to\x20perform.\n\n\x0c\n\x05\x04\0\x08\0\x01\x12\x03F\x08\x11\n\x89\x01\
    \n\x04\x04\0\x02\0\x12\x03I\x04\x15\x1a|\x20Insert\x20new\x20rows\x20in\
    \x20a\x20table.\x20If\x20any\x20of\x20the\x20rows\x20already\x20exist,\n\
    \x20the\x20write\x20or\x20transaction\x20fails\x20with\x20error\x20`ALRE\
    ADY_EXISTS`.\n\n\x0c\n\x05\x04\0\x02\0\x06\x12\x03I\x04\t\n\x0c\n\x05\
    \x04\0\x02\0\x01\x12\x03I\n\x10\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03I\x13\
    \x14\n\x89\x01\n\x04\x04\0\x02\x01\x12\x03M\x04\x15\x1a|\x20Update\x20ex\
    isting\x20rows\x20in\x20a\x20table.\x20If\x20any\x20of\x20the\x20rows\
    \x20does\x20not\n\x20already\x20exist,\x20the\x20transaction\x20fails\
    \x20with\x20error\x20`NOT_FOUND`.\n\n\x0c\n\x05\x04\0\x02\x01\x06\x12\
    \x03M\x04\t\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03M\n\x10\n\x0c\n\x05\x04\
    \0\x02\x01\x03\x12\x03M\x13\x14\n\xe1\x01\n\x04\x04\0\x02\x02\x12\x03R\
    \x04\x1f\x1a\xd3\x01\x20Like\x20[insert][google.spanner.v1.Mutation.inse\
    rt],\x20except\x20that\x20if\x20the\x20row\x20already\x20exists,\x20then\
    \n\x20its\x20column\x20values\x20are\x20overwritten\x20with\x20the\x20on\
    es\x20provided.\x20Any\n\x20column\x20values\x20not\x20explicitly\x20wri\
    tten\x20are\x20preserved.\n\n\x0c\n\x05\x04\0\x02\x02\x06\x12\x03R\x04\t\
    \n\x0c\n\x05\x04\0\x02\x02\x01\x12\x03R\n\x1a\n\x0c\n\x05\x04\0\x02\x02\
    \x03\x12\x03R\x1d\x1e\n\xb3\x02\n\x04\x04\0\x02\x03\x12\x03X\x04\x16\x1a\
    \xa5\x02\x20Like\x20[insert][google.spanner.v1.Mutation.insert],\x20exce\
    pt\x20that\x20if\x20the\x20row\x20already\x20exists,\x20it\x20is\n\x20de\
    leted,\x20and\x20the\x20column\x20values\x20provided\x20are\x20inserted\
    \n\x20instead.\x20Unlike\x20[insert_or_update][google.spanner.v1.Mutatio\
    n.insert_or_update],\x20this\x20means\x20any\x20values\x20not\n\x20expli\
    citly\x20written\x20become\x20`NULL`.\n\n\x0c\n\x05\x04\0\x02\x03\x06\
    \x12\x03X\x04\t\n\x0c\n\x05\x04\0\x02\x03\x01\x12\x03X\n\x11\n\x0c\n\x05\
    \x04\0\x02\x03\x03\x12\x03X\x14\x15\n^\n\x04\x04\0\x02\x04\x12\x03\\\x04\
    \x16\x1aQ\x20Delete\x20rows\x20from\x20a\x20table.\x20Succeeds\x20whethe\
    r\x20or\x20not\x20the\x20named\n\x20rows\x20were\x20present.\n\n\x0c\n\
    \x05\x04\0\x02\x04\x06\x12\x03\\\x04\n\n\x0c\n\x05\x04\0\x02\x04\x01\x12\
    \x03\\\x0b\x11\n\x0c\n\x05\x04\0\x02\x04\x03\x12\x03\\\x14\x15b\x06proto\
    3\
";
