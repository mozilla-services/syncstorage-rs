...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \xbe\x01\n\x02\x04\0\x12\x04!\0c\x01\x1a\xb1\x01\x20A\x20modification\
    \x20to\x20one\x20or\x20more\x20Cloud\x20Spanner\x20rows.\x20\x20Mutation\
    s\x20can\x20be\n\x20applied\x20to\x20a\x20Cloud\x20Spanner\x20database\
    \x20by\x20sending\x20them\x20in\x20a\n\x20[Commit][google.spanner.v1.Spa\
    nner.Commit]\x20call.\n\n\n\n\x03\x04\0\x01\x12\x03!\x08\x10\n\xf7\x01\n\
    \x04\x04\0\x03\0\x12\x04$\x028\x03\x1a\xe8\x01\x20Arguments\x20to\x20[in\
    sert][google.spanner.v1.Mutation.insert],\x20[update][google.spanner.v1.\
    Mutation.update],\x20[insert_or_update][google.spanner.v1.Mutation.inser\
    t_or_update],\x20and\n\x20[replace][google.spanner.v1.Mutation.replace]\
    \x20operations.\n\n\x0c\n\x05\x04\0\x03\0\x01\x12\x03$\n\x0f\n@\n\x06\
    \x04\0\x03\0\x02\0\x12\x03&\x04\x15\x1a1\x20Required.\x20The\x20table\
    \x20whose\x20rows\x20will\x20be\x20written.\n\n\x0f\n\x07\x04\0\x03\0\
    ...
    \x13\x14\n\xd7\x01\n\x06\x04\0\x03\x01\x02\x01\x12\x03B\x04\x17\x1a\xc7\
    \x01\x20Required.\x20The\x20primary\x20keys\x20of\x20the\x20rows\x20with\
    in\x20[table][google.spanner.v1.Mutation.Delete.table]\x20to\x20delete.\
    \n\x20Delete\x20is\x20idempotent.\x20The\x20transaction\x20will\x20succe\
    ed\x20even\x20if\x20some\x20or\x20all\n\x20rows\x20do\x20not\x20exist.\n\
    \n\x0f\n\x07\x04\0\x03\x01\x02\x01\x04\x12\x04B\x04=\x15\n\x0e\n\x07\x04\
    \0\x03\x01\x02\x01\x06\x12\x03B\x04\n\n\x0e\n\x07\x04\0\x03\x01\x02\x01\
    \x01\x12\x03B\x0b\x12\n\x0e\n\x07\x04\0\x03\x01\x02\x01\x03\x12\x03B\x15\
    \x16\n3\n\x04\x04\0\x08\0\x12\x04F\x02b\x03\x1a%\x20Required.\x20The\x20\
    operation\x20to\x20perform.\n\n\x0c\n\x05\x04\0\x08\0\x01\x12\x03F\x08\
    \x11\n\x89\x01\n\x04\x04\0\x02\0\x12\x03I\x04\x15\x1a|\x20Insert\x20new\
    \x20rows\x20in\x20a\x20table.\x20If\x20any\x20of\x20the\x20rows\x20alrea\
    dy\x20exist,\n\x20the\x20write\x20or\x20transaction\x20fails\x20with\x20\
    error\x20`ALREADY_EXISTS`.\n\n\x0c\n\x05\x04\0\x02\0\x06\x12\x03I\x04\t\
    \n\x0c\n\x05\x04\0\x02\0\x01\x12\x03I\n\x10\n\x0c\n\x05\x04\0\x02\0\x03\
    \x12\x03I\x13\x14\n\x89\x01\n\x04\x04\0\x02\x01\x12\x03M\x04\x15\x1a|\
    \x20Update\x20existing\x20rows\x20in\x20a\x20table.\x20If\x20any\x20of\
    \x20the\x20rows\x20does\x20not\n\x20already\x20exist,\x20the\x20transact\
    ion\x20fails\x20with\x20error\x20`NOT_FOUND`.\n\n\x0c\n\x05\x04\0\x02\
    \x01\x06\x12\x03M\x04\t\n\x0c\n\x05\x04\0\x02\x01\x01\x12\x03M\n\x10\n\
    \x0c\n\x05\x04\0\x02\x01\x03\x12\x03M\x13\x14\n\xe1\x01\n\x04\x04\0\x02\
    \x02\x12\x03R\x04\x1f\x1a\xd3\x01\x20Like\x20[insert][google.spanner.v1.\
    Mutation.insert],\x20except\x20that\x20if\x20the\x20row\x20already\x20ex\
    ists,\x20then\n\x20its\x20column\x20values\x20are\x20overwritten\x20with\
    \x20the\x20ones\x20provided.\x20Any\n\x20column\x20values\x20not\x20expl\
    icitly\x20written\x20are\x20preserved.\n\n\x0c\n\x05\x04\0\x02\x02\x06\
    \x12\x03R\x04\t\n\x0c\n\x05\x04\0\x02\x02\x01\x12\x03R\n\x1a\n\x0c\n\x05\
    \x04\0\x02\x02\x03\x12\x03R\x1d\x1e\n\x9e\x04\n\x04\x04\0\x02\x03\x12\
    \x03]\x04\x16\x1a\x90\x04\x20Like\x20[insert][google.spanner.v1.Mutation\
    .insert],\x20except\x20that\x20if\x20the\x20row\x20already\x20exists,\
    \x20it\x20is\n\x20deleted,\x20and\x20the\x20column\x20values\x20provided\
    \x20are\x20inserted\n\x20instead.\x20Unlike\x20[insert_or_update][google\
    .spanner.v1.Mutation.insert_or_update],\x20this\x20means\x20any\x20value\
    s\x20not\n\x20explicitly\x20written\x20become\x20`NULL`.\n\n\x20In\x20an\
    \x20interleaved\x20table,\x20if\x20you\x20create\x20the\x20child\x20tabl\
    e\x20with\x20the\n\x20`ON\x20DELETE\x20CASCADE`\x20annotation,\x20then\
    \x20replacing\x20a\x20parent\x20row\n\x20also\x20deletes\x20the\x20child\
    \x20rows.\x20Otherwise,\x20you\x20must\x20delete\x20the\n\x20child\x20ro\
    ws\x20before\x20you\x20replace\x20the\x20parent\x20row.\n\n\x0c\n\x05\
    \x04\0\x02\x03\x06\x12\x03]\x04\t\n\x0c\n\x05\x04\0\x02\x03\x01\x12\x03]\
    \n\x11\n\x0c\n\x05\x04\0\x02\x03\x03\x12\x03]\x14\x15\n^\n\x04\x04\0\x02\
    \x04\x12\x03a\x04\x16\x1aQ\x20Delete\x20rows\x20from\x20a\x20table.\x20S\
    ucceeds\x20whether\x20or\x20not\x20the\x20named\n\x20rows\x20were\x20pre\
    sent.\n\n\x0c\n\x05\x04\0\x02\x04\x06\x12\x03a\x04\n\n\x0c\n\x05\x04\0\
    \x02\x04\x01\x12\x03a\x0b\x11\n\x0c\n\x05\x04\0\x02\x04\x03\x12\x03a\x14\
    \x15b\x06proto3\
";
