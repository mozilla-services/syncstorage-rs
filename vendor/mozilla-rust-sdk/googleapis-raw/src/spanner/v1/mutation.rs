...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    le.Cloud.Spanner.V1\xca\x02\x17Google\\Cloud\\Spanner\\V1\xea\x02\x1aGoo\
    gle::Cloud::Spanner::V1J\xd2%\n\x06\x12\x04\x0e\0j\x01\n\xbc\x04\n\x01\
    ...
    \x08-\x12\x03\x1c\03\n\xbe\x01\n\x02\x04\0\x12\x04!\0j\x01\x1a\xb1\x01\
    \x20A\x20modification\x20to\x20one\x20or\x20more\x20Cloud\x20Spanner\x20\
    rows.\x20\x20Mutations\x20can\x20be\n\x20applied\x20to\x20a\x20Cloud\x20\
    Spanner\x20database\x20by\x20sending\x20them\x20in\x20a\n\x20[Commit][go\
    ogle.spanner.v1.Spanner.Commit]\x20call.\n\n\n\n\x03\x04\0\x01\x12\x03!\
    \x08\x10\n\xf7\x01\n\x04\x04\0\x03\0\x12\x04$\x028\x03\x1a\xe8\x01\x20Ar\
    guments\x20to\x20[insert][google.spanner.v1.Mutation.insert],\x20[update\
    ][google.spanner.v1.Mutation.update],\x20[insert_or_update][google.spann\
    er.v1.Mutation.insert_or_update],\x20and\n\x20[replace][google.spanner.v\
    1.Mutation.replace]\x20operations.\n\n\x0c\n\x05\x04\0\x03\0\x01\x12\x03\
    $\n\x0f\n@\n\x06\x04\0\x03\0\x02\0\x12\x03&\x04\x15\x1a1\x20Required.\
    \x20The\x20table\x20whose\x20rows\x20will\x20be\x20written.\n\n\x0f\n\
    ...
    \0\x03\0\x02\x01\x12\x03-\x04\x20\x1a\xf2\x01\x20The\x20names\x20of\x20t\
    he\x20columns\x20in\x20[table][google.spanner.v1.Mutation.Write.table]\
    \x20to\x20be\x20written.\n\n\x20The\x20list\x20of\x20columns\x20must\x20\
    contain\x20enough\x20columns\x20to\x20allow\n\x20Cloud\x20Spanner\x20to\
    \x20derive\x20values\x20for\x20all\x20primary\x20key\x20columns\x20in\
    ...
    \0\x02\x02\x12\x037\x042\x1a\xe8\x04\x20The\x20values\x20to\x20be\x20wri\
    tten.\x20`values`\x20can\x20contain\x20more\x20than\x20one\n\x20list\x20\
    of\x20values.\x20If\x20it\x20does,\x20then\x20multiple\x20rows\x20are\
    \x20written,\x20one\n\x20for\x20each\x20entry\x20in\x20`values`.\x20Each\
    \x20list\x20in\x20`values`\x20must\x20have\n\x20exactly\x20as\x20many\
    \x20entries\x20as\x20there\x20are\x20entries\x20in\x20[columns][google.s\
    panner.v1.Mutation.Write.columns]\n\x20above.\x20Sending\x20multiple\x20\
    lists\x20is\x20equivalent\x20to\x20sending\x20multiple\n\x20`Mutation`s,\
    \x20each\x20containing\x20one\x20`values`\x20entry\x20and\x20repeating\n\
    \x20[table][google.spanner.v1.Mutation.Write.table]\x20and\x20[columns][\
    google.spanner.v1.Mutation.Write.columns].\x20Individual\x20values\x20in\
    \x20each\x20list\x20are\n\x20encoded\x20as\x20described\x20[here][google\
    .spanner.v1.TypeCode].\n\n\x0e\n\x07\x04\0\x03\0\x02\x02\x04\x12\x037\
    \x04\x0c\n\x0e\n\x07\x04\0\x03\0\x02\x02\x06\x12\x037\r&\n\x0e\n\x07\x04\
    \0\x03\0\x02\x02\x01\x12\x037'-\n\x0e\n\x07\x04\0\x03\0\x02\x02\x03\x12\
    \x03701\nT\n\x04\x04\0\x03\x01\x12\x04;\x02F\x03\x1aF\x20Arguments\x20to\
    \x20[delete][google.spanner.v1.Mutation.delete]\x20operations.\n\n\x0c\n\
    \x05\x04\0\x03\x01\x01\x12\x03;\n\x10\n@\n\x06\x04\0\x03\x01\x02\0\x12\
    \x03=\x04\x15\x1a1\x20Required.\x20The\x20table\x20whose\x20rows\x20will\
    \x20be\x20deleted.\n\n\x0f\n\x07\x04\0\x03\x01\x02\0\x04\x12\x04=\x04;\
    \x12\n\x0e\n\x07\x04\0\x03\x01\x02\0\x05\x12\x03=\x04\n\n\x0e\n\x07\x04\
    \0\x03\x01\x02\0\x01\x12\x03=\x0b\x10\n\x0e\n\x07\x04\0\x03\x01\x02\0\
    \x03\x12\x03=\x13\x14\n\x94\x03\n\x06\x04\0\x03\x01\x02\x01\x12\x03E\x04\
    \x17\x1a\x84\x03\x20Required.\x20The\x20primary\x20keys\x20of\x20the\x20\
    rows\x20within\x20[table][google.spanner.v1.Mutation.Delete.table]\x20to\
    \x20delete.\x20\x20The\n\x20primary\x20keys\x20must\x20be\x20specified\
    \x20in\x20the\x20order\x20in\x20which\x20they\x20appear\x20in\x20the\n\
    \x20`PRIMARY\x20KEY()`\x20clause\x20of\x20the\x20table's\x20equivalent\
    \x20DDL\x20statement\x20(the\x20DDL\n\x20statement\x20used\x20to\x20crea\
    te\x20the\x20table).\n\x20Delete\x20is\x20idempotent.\x20The\x20transact\
    ion\x20will\x20succeed\x20even\x20if\x20some\x20or\x20all\n\x20rows\x20d\
    o\x20not\x20exist.\n\n\x0f\n\x07\x04\0\x03\x01\x02\x01\x04\x12\x04E\x04=\
    \x15\n\x0e\n\x07\x04\0\x03\x01\x02\x01\x06\x12\x03E\x04\n\n\x0e\n\x07\
    \x04\0\x03\x01\x02\x01\x01\x12\x03E\x0b\x12\n\x0e\n\x07\x04\0\x03\x01\
    \x02\x01\x03\x12\x03E\x15\x16\n3\n\x04\x04\0\x08\0\x12\x04I\x02i\x03\x1a\
    %\x20Required.\x20The\x20operation\x20to\x20perform.\n\n\x0c\n\x05\x04\0\
    \x08\0\x01\x12\x03I\x08\x11\n\x89\x01\n\x04\x04\0\x02\0\x12\x03L\x04\x15\
    \x1a|\x20Insert\x20new\x20rows\x20in\x20a\x20table.\x20If\x20any\x20of\
    \x20the\x20rows\x20already\x20exist,\n\x20the\x20write\x20or\x20transact\
    ion\x20fails\x20with\x20error\x20`ALREADY_EXISTS`.\n\n\x0c\n\x05\x04\0\
    \x02\0\x06\x12\x03L\x04\t\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03L\n\x10\n\
    \x0c\n\x05\x04\0\x02\0\x03\x12\x03L\x13\x14\n\x89\x01\n\x04\x04\0\x02\
    \x01\x12\x03P\x04\x15\x1a|\x20Update\x20existing\x20rows\x20in\x20a\x20t\
    able.\x20If\x20any\x20of\x20the\x20rows\x20does\x20not\n\x20already\x20e\
    xist,\x20the\x20transaction\x20fails\x20with\x20error\x20`NOT_FOUND`.\n\
    \n\x0c\n\x05\x04\0\x02\x01\x06\x12\x03P\x04\t\n\x0c\n\x05\x04\0\x02\x01\
    \x01\x12\x03P\n\x10\n\x0c\n\x05\x04\0\x02\x01\x03\x12\x03P\x13\x14\n\x85\
    \x04\n\x04\x04\0\x02\x02\x12\x03Y\x04\x1f\x1a\xf7\x03\x20Like\x20[insert\
    ][google.spanner.v1.Mutation.insert],\x20except\x20that\x20if\x20the\x20\
    row\x20already\x20exists,\x20then\n\x20its\x20column\x20values\x20are\
    \x20overwritten\x20with\x20the\x20ones\x20provided.\x20Any\n\x20column\
    \x20values\x20not\x20explicitly\x20written\x20are\x20preserved.\n\n\x20W\
    hen\x20using\x20[insert_or_update][google.spanner.v1.Mutation.insert_or_\
    update],\x20just\x20as\x20when\x20using\x20[insert][google.spanner.v1.Mu\
    tation.insert],\x20all\x20`NOT\n\x20NULL`\x20columns\x20in\x20the\x20tab\
    le\x20must\x20be\x20given\x20a\x20value.\x20This\x20holds\x20true\n\x20e\
    ven\x20when\x20the\x20row\x20already\x20exists\x20and\x20will\x20therefo\
    re\x20actually\x20be\x20updated.\n\n\x0c\n\x05\x04\0\x02\x02\x06\x12\x03\
    Y\x04\t\n\x0c\n\x05\x04\0\x02\x02\x01\x12\x03Y\n\x1a\n\x0c\n\x05\x04\0\
    \x02\x02\x03\x12\x03Y\x1d\x1e\n\x9e\x04\n\x04\x04\0\x02\x03\x12\x03d\x04\
    \x16\x1a\x90\x04\x20Like\x20[insert][google.spanner.v1.Mutation.insert],\
    \x20except\x20that\x20if\x20the\x20row\x20already\x20exists,\x20it\x20is\
    \n\x20deleted,\x20and\x20the\x20column\x20values\x20provided\x20are\x20i\
    nserted\n\x20instead.\x20Unlike\x20[insert_or_update][google.spanner.v1.\
    Mutation.insert_or_update],\x20this\x20means\x20any\x20values\x20not\n\
    \x20explicitly\x20written\x20become\x20`NULL`.\n\n\x20In\x20an\x20interl\
    eaved\x20table,\x20if\x20you\x20create\x20the\x20child\x20table\x20with\
    \x20the\n\x20`ON\x20DELETE\x20CASCADE`\x20annotation,\x20then\x20replaci\
    ng\x20a\x20parent\x20row\n\x20also\x20deletes\x20the\x20child\x20rows.\
    \x20Otherwise,\x20you\x20must\x20delete\x20the\n\x20child\x20rows\x20bef\
    ore\x20you\x20replace\x20the\x20parent\x20row.\n\n\x0c\n\x05\x04\0\x02\
    \x03\x06\x12\x03d\x04\t\n\x0c\n\x05\x04\0\x02\x03\x01\x12\x03d\n\x11\n\
    \x0c\n\x05\x04\0\x02\x03\x03\x12\x03d\x14\x15\n^\n\x04\x04\0\x02\x04\x12\
    \x03h\x04\x16\x1aQ\x20Delete\x20rows\x20from\x20a\x20table.\x20Succeeds\
    \x20whether\x20or\x20not\x20the\x20named\n\x20rows\x20were\x20present.\n\
    \n\x0c\n\x05\x04\0\x02\x04\x06\x12\x03h\x04\n\n\x0c\n\x05\x04\0\x02\x04\
    \x01\x12\x03h\x0b\x11\n\x0c\n\x05\x04\0\x02\x04\x03\x12\x03h\x14\x15b\
    \x06proto3\
";
