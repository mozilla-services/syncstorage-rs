...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    1\xca\x02\x17Google\\Cloud\\Spanner\\V1\xea\x02\x1aGoogle::Cloud::Spanne\
    ...
    \x05u\0\x8b\x01\x01\x1a\xa7\x15\x20KeyRange\x20represents\x20a\x20range\
    \x20of\x20rows\x20in\x20a\x20table\x20or\x20index.\n\n\x20A\x20range\x20\
    has\x20a\x20start\x20key\x20and\x20an\x20end\x20key.\x20These\x20keys\
    \x20can\x20be\x20open\x20or\n\x20closed,\x20indicating\x20if\x20the\x20r\
    ange\x20includes\x20rows\x20with\x20that\x20key.\n\n\x20Keys\x20are\x20r\
    epresented\x20by\x20lists,\x20where\x20the\x20ith\x20value\x20in\x20the\
    \x20list\n\x20corresponds\x20to\x20the\x20ith\x20component\x20of\x20the\
    \x20table\x20or\x20index\x20primary\x20key.\n\x20Individual\x20values\
    \x20are\x20encoded\x20as\x20described\n\x20[here][google.spanner.v1.Type\
    Code].\n\n\x20For\x20example,\x20consider\x20the\x20following\x20table\
    \x20definition:\n\n\x20\x20\x20\x20\x20CREATE\x20TABLE\x20UserEvents\x20\
    (\n\x20\x20\x20\x20\x20\x20\x20UserName\x20STRING(MAX),\n\x20\x20\x20\
    \x20\x20\x20\x20EventDate\x20STRING(10)\n\x20\x20\x20\x20\x20)\x20PRIMAR\
    Y\x20KEY(UserName,\x20EventDate);\n\n\x20The\x20following\x20keys\x20nam\
    e\x20rows\x20in\x20this\x20table:\n\n\x20\x20\x20\x20\x20[\"Bob\",\x20\"\
    2014-09-23\"]\n\x20\x20\x20\x20\x20[\"Alfred\",\x20\"2015-06-12\"]\n\n\
    \x20Since\x20the\x20`UserEvents`\x20table's\x20`PRIMARY\x20KEY`\x20claus\
    e\x20names\x20two\n\x20columns,\x20each\x20`UserEvents`\x20key\x20has\
    \x20two\x20elements;\x20the\x20first\x20is\x20the\n\x20`UserName`,\x20an\
    d\x20the\x20second\x20is\x20the\x20`EventDate`.\n\n\x20Key\x20ranges\x20\
    with\x20multiple\x20components\x20are\x20interpreted\n\x20lexicographica\
    lly\x20by\x20component\x20using\x20the\x20table\x20or\x20index\x20key's\
    \x20declared\n\x20sort\x20order.\x20For\x20example,\x20the\x20following\
    \x20range\x20returns\x20all\x20events\x20for\n\x20user\x20`\"Bob\"`\x20t\
    hat\x20occurred\x20in\x20the\x20year\x202015:\n\n\x20\x20\x20\x20\x20\"s\
    tart_closed\":\x20[\"Bob\",\x20\"2015-01-01\"]\n\x20\x20\x20\x20\x20\"en\
    d_closed\":\x20[\"Bob\",\x20\"2015-12-31\"]\n\n\x20Start\x20and\x20end\
    \x20keys\x20can\x20omit\x20trailing\x20key\x20components.\x20This\x20aff\
    ects\x20the\n\x20inclusion\x20and\x20exclusion\x20of\x20rows\x20that\x20\
    exactly\x20match\x20the\x20provided\x20key\n\x20components:\x20if\x20the\
    \x20key\x20is\x20closed,\x20then\x20rows\x20that\x20exactly\x20match\x20\
    the\n\x20provided\x20components\x20are\x20included;\x20if\x20the\x20key\
    \x20is\x20open,\x20then\x20rows\n\x20that\x20exactly\x20match\x20are\x20\
    not\x20included.\n\n\x20For\x20example,\x20the\x20following\x20range\x20\
    includes\x20all\x20events\x20for\x20`\"Bob\"`\x20that\n\x20occurred\x20d\
    uring\x20and\x20after\x20the\x20year\x202000:\n\n\x20\x20\x20\x20\x20\"s\
    tart_closed\":\x20[\"Bob\",\x20\"2000-01-01\"]\n\x20\x20\x20\x20\x20\"en\
    d_closed\":\x20[\"Bob\"]\n\n\x20The\x20next\x20example\x20retrieves\x20a\
    ll\x20events\x20for\x20`\"Bob\"`:\n\n\x20\x20\x20\x20\x20\"start_closed\
    \":\x20[\"Bob\"]\n\x20\x20\x20\x20\x20\"end_closed\":\x20[\"Bob\"]\n\n\
    \x20To\x20retrieve\x20events\x20before\x20the\x20year\x202000:\n\n\x20\
    \x20\x20\x20\x20\"start_closed\":\x20[\"Bob\"]\n\x20\x20\x20\x20\x20\"en\
    d_open\":\x20[\"Bob\",\x20\"2000-01-01\"]\n\n\x20The\x20following\x20ran\
    ge\x20includes\x20all\x20rows\x20in\x20the\x20table:\n\n\x20\x20\x20\x20\
    \x20\"start_closed\":\x20[]\n\x20\x20\x20\x20\x20\"end_closed\":\x20[]\n\
    \n\x20This\x20range\x20returns\x20all\x20users\x20whose\x20`UserName`\
    \x20begins\x20with\x20any\n\x20character\x20from\x20A\x20to\x20C:\n\n\
    \x20\x20\x20\x20\x20\"start_closed\":\x20[\"A\"]\n\x20\x20\x20\x20\x20\"\
    end_open\":\x20[\"D\"]\n\n\x20This\x20range\x20returns\x20all\x20users\
    \x20whose\x20`UserName`\x20begins\x20with\x20B:\n\n\x20\x20\x20\x20\x20\
    \"start_closed\":\x20[\"B\"]\n\x20\x20\x20\x20\x20\"end_open\":\x20[\"C\
    \"]\n\n\x20Key\x20ranges\x20honor\x20column\x20sort\x20order.\x20For\x20\
    example,\x20suppose\x20a\x20table\x20is\n\x20defined\x20as\x20follows:\n\
    ...
    following\x20range\x20retrieves\x20all\x20rows\x20with\x20key\x20values\
    \x20between\x201\n\x20and\x20100\x20inclusive:\n\n\x20\x20\x20\x20\x20\"\
    start_closed\":\x20[\"100\"]\n\x20\x20\x20\x20\x20\"end_closed\":\x20[\"\
    1\"]\n\n\x20Note\x20that\x20100\x20is\x20passed\x20as\x20the\x20start,\
    \x20and\x201\x20is\x20passed\x20as\x20the\x20end,\n\x20because\x20`Key`\
    \x20is\x20a\x20descending\x20column\x20in\x20the\x20schema.\n\n\n\n\x03\
    \x04\0\x01\x12\x03u\x08\x10\nP\n\x04\x04\0\x08\0\x12\x04w\x02\x7f\x03\
    \x1aB\x20The\x20start\x20key\x20must\x20be\x20provided.\x20It\x20can\x20\
    be\x20either\x20closed\x20or\x20open.\n\n\x0c\n\x05\x04\0\x08\0\x01\x12\
    \x03w\x08\x16\n\x93\x01\n\x04\x04\0\x02\0\x12\x03z\x04/\x1a\x85\x01\x20I\
    f\x20the\x20start\x20is\x20closed,\x20then\x20the\x20range\x20includes\
    \x20all\x20rows\x20whose\n\x20first\x20`len(start_closed)`\x20key\x20col\
    umns\x20exactly\x20match\x20`start_closed`.\n\n\x0c\n\x05\x04\0\x02\0\
    \x06\x12\x03z\x04\x1d\n\x0c\n\x05\x04\0\x02\0\x01\x12\x03z\x1e*\n\x0c\n\
    ...
    \n\x05\x04\0\x02\x01\x03\x12\x03~+,\nP\n\x04\x04\0\x08\x01\x12\x06\x82\
    \x01\x02\x8a\x01\x03\x1a@\x20The\x20end\x20key\x20must\x20be\x20provided\
    .\x20It\x20can\x20be\x20either\x20closed\x20or\x20open.\n\n\r\n\x05\x04\
    \0\x08\x01\x01\x12\x04\x82\x01\x08\x14\n\x8d\x01\n\x04\x04\0\x02\x02\x12\
    \x04\x85\x01\x04-\x1a\x7f\x20If\x20the\x20end\x20is\x20closed,\x20then\
    ...
    \x02\x01\x12\x04\x85\x01\x1e(\n\r\n\x05\x04\0\x02\x02\x03\x12\x04\x85\
    \x01+,\n\x83\x01\n\x04\x04\0\x02\x03\x12\x04\x89\x01\x04+\x1au\x20If\x20\
    the\x20end\x20is\x20open,\x20then\x20the\x20range\x20excludes\x20rows\
    \x20whose\x20first\n\x20`len(end_open)`\x20key\x20columns\x20exactly\x20\
    match\x20`end_open`.\n\n\r\n\x05\x04\0\x02\x03\x06\x12\x04\x89\x01\x04\
    \x1d\n\r\n\x05\x04\0\x02\x03\x01\x12\x04\x89\x01\x1e&\n\r\n\x05\x04\0\
    \x02\x03\x03\x12\x04\x89\x01)*\n\x86\x03\n\x02\x04\x01\x12\x06\x94\x01\0\
    \xa3\x01\x01\x1a\xf7\x02\x20`KeySet`\x20defines\x20a\x20collection\x20of\
    ...
    \x04\x99\x01,-\n\x86\x01\n\x04\x04\x01\x02\x01\x12\x04\x9d\x01\x02\x1f\
    ...
    ange\x20specifications.\n\n\r\n\x05\x04\x01\x02\x01\x04\x12\x04\x9d\x01\
    \x02\n\n\r\n\x05\x04\x01\x02\x01\x06\x12\x04\x9d\x01\x0b\x13\n\r\n\x05\
    \x04\x01\x02\x01\x01\x12\x04\x9d\x01\x14\x1a\n\r\n\x05\x04\x01\x02\x01\
    \x03\x12\x04\x9d\x01\x1d\x1e\n\xce\x01\n\x04\x04\x01\x02\x02\x12\x04\xa2\
    ...
    \xa2\x01\x02\x9d\x01\x1f\n\r\n\x05\x04\x01\x02\x02\x05\x12\x04\xa2\x01\
    \x02\x06\n\r\n\x05\x04\x01\x02\x02\x01\x12\x04\xa2\x01\x07\n\n\r\n\x05\
    \x04\x01\x02\x02\x03\x12\x04\xa2\x01\r\x0eb\x06proto3\
";
