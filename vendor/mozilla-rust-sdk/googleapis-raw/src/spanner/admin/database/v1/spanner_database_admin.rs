...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    *}\x12\xb0\x01\n\x11UpdateDatabaseDdl\x12:.google.spanner.admin.database\
    ...
    8\n\x04\x04\0\x02\x01\x12\x04\x9f\x01\x02\x12\x1a*\x20Output\x20only.\
    \x20The\x20current\x20database\x20state.\n\n\r\n\x05\x04\0\x02\x01\x06\
    \x12\x04\x9f\x01\x02\x07\n\r\n\x05\x04\0\x02\x01\x01\x12\x04\x9f\x01\x08\
    \r\n\r\n\x05\x04\0\x02\x01\x03\x12\x04\x9f\x01\x10\x11\nn\n\x02\x04\x01\
    \x12\x06\xa3\x01\0\xb0\x01\x01\x1a`\x20The\x20request\x20for\x20[ListDat\
    abases][google.spanner.admin.database.v1.DatabaseAdmin.ListDatabases].\n\
    \n\x0b\n\x03\x04\x01\x01\x12\x04\xa3\x01\x08\x1c\n\x8b\x01\n\x04\x04\x01\
    \x02\0\x12\x04\xa6\x01\x02\x14\x1a}\x20Required.\x20The\x20instance\x20w\
    hose\x20databases\x20should\x20be\x20listed.\n\x20Values\x20are\x20of\
    \x20the\x20form\x20`projects/<project>/instances/<instance>`.\n\n\r\n\
    \x05\x04\x01\x02\0\x05\x12\x04\xa6\x01\x02\x08\n\r\n\x05\x04\x01\x02\0\
    \x01\x12\x04\xa6\x01\t\x0f\n\r\n\x05\x04\x01\x02\0\x03\x12\x04\xa6\x01\
    \x12\x13\n\x86\x01\n\x04\x04\x01\x02\x01\x12\x04\xaa\x01\x02\x16\x1ax\
    ...
    \x12\x04\xaa\x01\x02\x07\n\r\n\x05\x04\x01\x02\x01\x01\x12\x04\xaa\x01\
    \x08\x11\n\r\n\x05\x04\x01\x02\x01\x03\x12\x04\xaa\x01\x14\x15\n\xf9\x01\
    \n\x04\x04\x01\x02\x02\x12\x04\xaf\x01\x02\x18\x1a\xea\x01\x20If\x20non-\
    empty,\x20`page_token`\x20should\x20contain\x20a\n\x20[next_page_token][\
    google.spanner.admin.database.v1.ListDatabasesResponse.next_page_token]\
    \x20from\x20a\n\x20previous\x20[ListDatabasesResponse][google.spanner.ad\
    min.database.v1.ListDatabasesResponse].\n\n\r\n\x05\x04\x01\x02\x02\x05\
    \x12\x04\xaf\x01\x02\x08\n\r\n\x05\x04\x01\x02\x02\x01\x12\x04\xaf\x01\t\
    \x13\n\r\n\x05\x04\x01\x02\x02\x03\x12\x04\xaf\x01\x16\x17\no\n\x02\x04\
    \x02\x12\x06\xb3\x01\0\xbb\x01\x01\x1aa\x20The\x20response\x20for\x20[Li\
    stDatabases][google.spanner.admin.database.v1.DatabaseAdmin.ListDatabase\
    s].\n\n\x0b\n\x03\x04\x02\x01\x12\x04\xb3\x01\x08\x1d\n3\n\x04\x04\x02\
    \x02\0\x12\x04\xb5\x01\x02\"\x1a%\x20Databases\x20that\x20matched\x20the\
    \x20request.\n\n\r\n\x05\x04\x02\x02\0\x04\x12\x04\xb5\x01\x02\n\n\r\n\
    \x05\x04\x02\x02\0\x06\x12\x04\xb5\x01\x0b\x13\n\r\n\x05\x04\x02\x02\0\
    \x01\x12\x04\xb5\x01\x14\x1d\n\r\n\x05\x04\x02\x02\0\x03\x12\x04\xb5\x01\
    \x20!\n\xbc\x01\n\x04\x04\x02\x02\x01\x12\x04\xba\x01\x02\x1d\x1a\xad\
    ...
    tDatabases]\x20call\x20to\x20fetch\x20more\n\x20of\x20the\x20matching\
    \x20databases.\n\n\r\n\x05\x04\x02\x02\x01\x05\x12\x04\xba\x01\x02\x08\n\
    \r\n\x05\x04\x02\x02\x01\x01\x12\x04\xba\x01\t\x18\n\r\n\x05\x04\x02\x02\
    \x01\x03\x12\x04\xba\x01\x1b\x1c\np\n\x02\x04\x03\x12\x06\xbe\x01\0\xcf\
    \x01\x01\x1ab\x20The\x20request\x20for\x20[CreateDatabase][google.spanne\
    r.admin.database.v1.DatabaseAdmin.CreateDatabase].\n\n\x0b\n\x03\x04\x03\
    \x01\x12\x04\xbe\x01\x08\x1d\n\x98\x01\n\x04\x04\x03\x02\0\x12\x04\xc1\
    \x01\x02\x14\x1a\x89\x01\x20Required.\x20The\x20name\x20of\x20the\x20ins\
    ...
    \x03\x02\0\x01\x12\x04\xc1\x01\t\x0f\n\r\n\x05\x04\x03\x02\0\x03\x12\x04\
    \xc1\x01\x12\x13\n\xe6\x02\n\x04\x04\x03\x02\x01\x12\x04\xc8\x01\x02\x1e\
    \x1a\xd7\x02\x20Required.\x20A\x20`CREATE\x20DATABASE`\x20statement,\x20\
    which\x20specifies\x20the\x20ID\x20of\x20the\n\x20new\x20database.\x20\
    \x20The\x20database\x20ID\x20must\x20conform\x20to\x20the\x20regular\x20\
    expression\n\x20`[a-z][a-z0-9_\\-]*[a-z0-9]`\x20and\x20be\x20between\x20\
    2\x20and\x2030\x20characters\x20in\x20length.\n\x20If\x20the\x20database\
    \x20ID\x20is\x20a\x20reserved\x20word\x20or\x20if\x20it\x20contains\x20a\
    \x20hyphen,\x20the\n\x20database\x20ID\x20must\x20be\x20enclosed\x20in\
    \x20backticks\x20(``\x20`\x20``).\n\n\r\n\x05\x04\x03\x02\x01\x05\x12\
    ...
    \x04\x04\x02\0\x01\x12\x04\xd5\x01\t\x11\n\r\n\x05\x04\x04\x02\0\x03\x12\
    \x04\xd5\x01\x14\x15\nj\n\x02\x04\x05\x12\x06\xd9\x01\0\xdd\x01\x01\x1a\
    \\\x20The\x20request\x20for\x20[GetDatabase][google.spanner.admin.databa\
    se.v1.DatabaseAdmin.GetDatabase].\n\n\x0b\n\x03\x04\x05\x01\x12\x04\xd9\
    \x01\x08\x1a\n\x96\x01\n\x04\x04\x05\x02\0\x12\x04\xdc\x01\x02\x12\x1a\
    ...
    \x12\x06\xef\x01\0\x8a\x02\x01\x1a\x8a\x07\x20Enqueues\x20the\x20given\
    \x20DDL\x20statements\x20to\x20be\x20applied,\x20in\x20order\x20but\x20n\
    ot\n\x20necessarily\x20all\x20at\x20once,\x20to\x20the\x20database\x20sc\
    hema\x20at\x20some\x20point\x20(or\n\x20points)\x20in\x20the\x20future.\
    \x20The\x20server\x20checks\x20that\x20the\x20statements\n\x20are\x20exe\
    cutable\x20(syntactically\x20valid,\x20name\x20tables\x20that\x20exist,\
    \x20etc.)\n\x20before\x20enqueueing\x20them,\x20but\x20they\x20may\x20st\
    ill\x20fail\x20upon\n\x20later\x20execution\x20(e.g.,\x20if\x20a\x20stat\
    ement\x20from\x20another\x20batch\x20of\n\x20statements\x20is\x20applied\
    \x20first\x20and\x20it\x20conflicts\x20in\x20some\x20way,\x20or\x20if\n\
    \x20there\x20is\x20some\x20data-related\x20problem\x20like\x20a\x20`NULL\
    `\x20value\x20in\x20a\x20column\x20to\n\x20which\x20`NOT\x20NULL`\x20wou\
    ld\x20be\x20added).\x20If\x20a\x20statement\x20fails,\x20all\n\x20subseq\
    uent\x20statements\x20in\x20the\x20batch\x20are\x20automatically\x20canc\
    elled.\n\n\x20Each\x20batch\x20of\x20statements\x20is\x20assigned\x20a\
    \x20name\x20which\x20can\x20be\x20used\x20with\n\x20the\x20[Operations][\
    google.longrunning.Operations]\x20API\x20to\x20monitor\n\x20progress.\
    \x20See\x20the\n\x20[operation_id][google.spanner.admin.database.v1.Upda\
    teDatabaseDdlRequest.operation_id]\x20field\x20for\x20more\n\x20details.\
    \n\n\x0b\n\x03\x04\x06\x01\x12\x04\xef\x01\x08\x20\n1\n\x04\x04\x06\x02\
    \0\x12\x04\xf1\x01\x02\x16\x1a#\x20Required.\x20The\x20database\x20to\
    \x20update.\n\n\r\n\x05\x04\x06\x02\0\x05\x12\x04\xf1\x01\x02\x08\n\r\n\
    \x05\x04\x06\x02\0\x01\x12\x04\xf1\x01\t\x11\n\r\n\x05\x04\x06\x02\0\x03\
    \x12\x04\xf1\x01\x14\x15\n=\n\x04\x04\x06\x02\x01\x12\x04\xf4\x01\x02!\
    \x1a/\x20DDL\x20statements\x20to\x20be\x20applied\x20to\x20the\x20databa\
    se.\n\n\r\n\x05\x04\x06\x02\x01\x04\x12\x04\xf4\x01\x02\n\n\r\n\x05\x04\
    \x06\x02\x01\x05\x12\x04\xf4\x01\x0b\x11\n\r\n\x05\x04\x06\x02\x01\x01\
    \x12\x04\xf4\x01\x12\x1c\n\r\n\x05\x04\x06\x02\x01\x03\x12\x04\xf4\x01\
    \x1f\x20\n\xe4\x08\n\x04\x04\x06\x02\x02\x12\x04\x89\x02\x02\x1a\x1a\xd5\
    ...
    admin.database.v1.DatabaseAdmin.UpdateDatabaseDdl]\x20call\x20is\x20repl\
    ayed,\n\x20or\x20the\x20return\x20value\x20is\x20otherwise\x20lost:\x20t\
    he\x20[database][google.spanner.admin.database.v1.UpdateDatabaseDdlReque\
    st.database]\x20and\n\x20`operation_id`\x20fields\x20can\x20be\x20combin\
    ed\x20to\x20form\x20the\n\x20[name][google.longrunning.Operation.name]\
    \x20of\x20the\x20resulting\n\x20[longrunning.Operation][google.longrunni\
    ng.Operation]:\x20`<database>/operations/<operation_id>`.\n\n\x20`operat\
    ion_id`\x20should\x20be\x20unique\x20within\x20the\x20database,\x20and\
    ...
    database.v1.DatabaseAdmin.UpdateDatabaseDdl]\x20returns\n\x20`ALREADY_EX\
    ISTS`.\n\n\r\n\x05\x04\x06\x02\x02\x05\x12\x04\x89\x02\x02\x08\n\r\n\x05\
    \x04\x06\x02\x02\x01\x12\x04\x89\x02\t\x15\n\r\n\x05\x04\x06\x02\x02\x03\
    \x12\x04\x89\x02\x18\x19\n\x94\x01\n\x02\x04\x07\x12\x06\x8e\x02\0\x9a\
    \x02\x01\x1a\x85\x01\x20Metadata\x20type\x20for\x20the\x20operation\x20r\
    eturned\x20by\n\x20[UpdateDatabaseDdl][google.spanner.admin.database.v1.\
    DatabaseAdmin.UpdateDatabaseDdl].\n\n\x0b\n\x03\x04\x07\x01\x12\x04\x8e\
    \x02\x08!\n,\n\x04\x04\x07\x02\0\x12\x04\x90\x02\x02\x16\x1a\x1e\x20The\
    ...
    \x02\x01\x12\x04\x94\x02\x02!\x1a|\x20For\x20an\x20update\x20this\x20lis\
    t\x20contains\x20all\x20the\x20statements.\x20For\x20an\n\x20individual\
    \x20statement,\x20this\x20list\x20contains\x20only\x20that\x20statement.\
    \n\n\r\n\x05\x04\x07\x02\x01\x04\x12\x04\x94\x02\x02\n\n\r\n\x05\x04\x07\
    \x02\x01\x05\x12\x04\x94\x02\x0b\x11\n\r\n\x05\x04\x07\x02\x01\x01\x12\
    \x04\x94\x02\x12\x1c\n\r\n\x05\x04\x07\x02\x01\x03\x12\x04\x94\x02\x1f\
    \x20\n\xb6\x01\n\x04\x04\x07\x02\x02\x12\x04\x99\x02\x02;\x1a\xa7\x01\
    \x20Reports\x20the\x20commit\x20timestamps\x20of\x20all\x20statements\
    \x20that\x20have\n\x20succeeded\x20so\x20far,\x20where\x20`commit_timest\
    amps[i]`\x20is\x20the\x20commit\n\x20timestamp\x20for\x20the\x20statemen\
    t\x20`statements[i]`.\n\n\r\n\x05\x04\x07\x02\x02\x04\x12\x04\x99\x02\
    \x02\n\n\r\n\x05\x04\x07\x02\x02\x06\x12\x04\x99\x02\x0b$\n\r\n\x05\x04\
    \x07\x02\x02\x01\x12\x04\x99\x02%6\n\r\n\x05\x04\x07\x02\x02\x03\x12\x04\
    \x99\x029:\nl\n\x02\x04\x08\x12\x06\x9d\x02\0\xa0\x02\x01\x1a^\x20The\
    \x20request\x20for\x20[DropDatabase][google.spanner.admin.database.v1.Da\
    tabaseAdmin.DropDatabase].\n\n\x0b\n\x03\x04\x08\x01\x12\x04\x9d\x02\x08\
    \x1b\n5\n\x04\x04\x08\x02\0\x12\x04\x9f\x02\x02\x16\x1a'\x20Required.\
    \x20The\x20database\x20to\x20be\x20dropped.\n\n\r\n\x05\x04\x08\x02\0\
    ...
    \xa9\x02\0\xad\x02\x01\x1ac\x20The\x20response\x20for\x20[GetDatabaseDdl\
    ][google.spanner.admin.database.v1.DatabaseAdmin.GetDatabaseDdl].\n\n\
    \x0b\n\x03\x04\n\x01\x12\x04\xa9\x02\x08\x1e\nq\n\x04\x04\n\x02\0\x12\
    \x04\xac\x02\x02!\x1ac\x20A\x20list\x20of\x20formatted\x20DDL\x20stateme\
    nts\x20defining\x20the\x20schema\x20of\x20the\x20database\n\x20specified\
    \x20in\x20the\x20request.\n\n\r\n\x05\x04\n\x02\0\x04\x12\x04\xac\x02\
