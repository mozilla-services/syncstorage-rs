...
pub trait BigtableTableAdmin {
    fn create_table(&mut self, ctx: ::grpcio::RpcContext, _req: super::bigtable_table_admin::CreateTableRequest, sink: ::grpcio::UnarySink<super::table::Table>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn create_table_from_snapshot(&mut self, ctx: ::grpcio::RpcContext, _req: super::bigtable_table_admin::CreateTableFromSnapshotRequest, sink: ::grpcio::UnarySink<super::operations::Operation>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn list_tables(&mut self, ctx: ::grpcio::RpcContext, _req: super::bigtable_table_admin::ListTablesRequest, sink: ::grpcio::UnarySink<super::bigtable_table_admin::ListTablesResponse>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    ...
    fn drop_row_range(&mut self, ctx: ::grpcio::RpcContext, _req: super::bigtable_table_admin::DropRowRangeRequest, sink: ::grpcio::UnarySink<super::empty::Empty>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn generate_consistency_token(&mut self, ctx: ::grpcio::RpcContext, _req: super::bigtable_table_admin::GenerateConsistencyTokenRequest, sink: ::grpcio::UnarySink<super::bigtable_table_admin::GenerateConsistencyTokenResponse>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn check_consistency(&mut self, ctx: ::grpcio::RpcContext, _req: super::bigtable_table_admin::CheckConsistencyRequest, sink: ::grpcio::UnarySink<super::bigtable_table_admin::CheckConsistencyResponse>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn snapshot_table(&mut self, ctx: ::grpcio::RpcContext, _req: super::bigtable_table_admin::SnapshotTableRequest, sink: ::grpcio::UnarySink<super::operations::Operation>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn get_snapshot(&mut self, ctx: ::grpcio::RpcContext, _req: super::bigtable_table_admin::GetSnapshotRequest, sink: ::grpcio::UnarySink<super::table::Snapshot>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn list_snapshots(&mut self, ctx: ::grpcio::RpcContext, _req: super::bigtable_table_admin::ListSnapshotsRequest, sink: ::grpcio::UnarySink<super::bigtable_table_admin::ListSnapshotsResponse>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
