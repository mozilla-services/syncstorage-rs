...
const METHOD_BIGTABLE_TABLE_ADMIN_CREATE_TABLE: ::grpcio::Method<
    super::bigtable_table_admin::CreateTableRequest,
    super::table::Table,
> = ::grpcio::Method {
...
const METHOD_BIGTABLE_TABLE_ADMIN_CREATE_TABLE_FROM_SNAPSHOT: ::grpcio::Method<
    super::bigtable_table_admin::CreateTableFromSnapshotRequest,
...
const METHOD_BIGTABLE_TABLE_ADMIN_LIST_TABLES: ::grpcio::Method<
    super::bigtable_table_admin::ListTablesRequest,
    super::bigtable_table_admin::ListTablesResponse,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_BIGTABLE_TABLE_ADMIN_GET_TABLE: ::grpcio::Method<
    super::bigtable_table_admin::GetTableRequest,
    super::table::Table,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_BIGTABLE_TABLE_ADMIN_DELETE_TABLE: ::grpcio::Method<
    super::bigtable_table_admin::DeleteTableRequest,
    super::empty::Empty,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_BIGTABLE_TABLE_ADMIN_MODIFY_COLUMN_FAMILIES: ::grpcio::Method<
    super::bigtable_table_admin::ModifyColumnFamiliesRequest,
    super::table::Table,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_BIGTABLE_TABLE_ADMIN_DROP_ROW_RANGE: ::grpcio::Method<
    super::bigtable_table_admin::DropRowRangeRequest,
    super::empty::Empty,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_BIGTABLE_TABLE_ADMIN_GENERATE_CONSISTENCY_TOKEN: ::grpcio::Method<
    super::bigtable_table_admin::GenerateConsistencyTokenRequest,
    super::bigtable_table_admin::GenerateConsistencyTokenResponse,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_BIGTABLE_TABLE_ADMIN_CHECK_CONSISTENCY: ::grpcio::Method<
    super::bigtable_table_admin::CheckConsistencyRequest,
    super::bigtable_table_admin::CheckConsistencyResponse,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_BIGTABLE_TABLE_ADMIN_SNAPSHOT_TABLE: ::grpcio::Method<
    super::bigtable_table_admin::SnapshotTableRequest,
    super::operations::Operation,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_BIGTABLE_TABLE_ADMIN_GET_SNAPSHOT: ::grpcio::Method<
    super::bigtable_table_admin::GetSnapshotRequest,
...
const METHOD_BIGTABLE_TABLE_ADMIN_LIST_SNAPSHOTS: ::grpcio::Method<
    super::bigtable_table_admin::ListSnapshotsRequest,
    super::bigtable_table_admin::ListSnapshotsResponse,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_BIGTABLE_TABLE_ADMIN_DELETE_SNAPSHOT: ::grpcio::Method<
    super::bigtable_table_admin::DeleteSnapshotRequest,
    super::empty::Empty,
> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
...
const METHOD_BIGTABLE_TABLE_ADMIN_GET_IAM_POLICY: ::grpcio::Method<
...
const METHOD_BIGTABLE_TABLE_ADMIN_SET_IAM_POLICY: ::grpcio::Method<
...
const METHOD_BIGTABLE_TABLE_ADMIN_TEST_IAM_PERMISSIONS: ::grpcio::Method<
...
impl BigtableTableAdminClient {
    ...
    ) -> ::grpcio::Result<super::table::Table> {
        self.client
            .unary_call(&METHOD_BIGTABLE_TABLE_ADMIN_CREATE_TABLE, req, opt)
    }
    ...
    pub fn create_table_async_opt(
        ...
        req: &super::bigtable_table_admin::CreateTableRequest,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::table::Table>> {
        self.client
            .unary_call_async(&METHOD_BIGTABLE_TABLE_ADMIN_CREATE_TABLE, req, opt)
    }
    ...
    pub fn create_table_from_snapshot_opt(
        ...
        self.client.unary_call(
            &METHOD_BIGTABLE_TABLE_ADMIN_CREATE_TABLE_FROM_SNAPSHOT,
            req,
            opt,
        )
    }
    ...
    pub fn list_tables_opt(
        ...
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<super::bigtable_table_admin::ListTablesResponse> {
        self.client
            .unary_call(&METHOD_BIGTABLE_TABLE_ADMIN_LIST_TABLES, req, opt)
    }
    ...
    pub fn list_tables_async_opt(
        ...
        ::grpcio::ClientUnaryReceiver<super::bigtable_table_admin::ListTablesResponse>,
    > {
        self.client
            .unary_call_async(&METHOD_BIGTABLE_TABLE_ADMIN_LIST_TABLES, req, opt)
    }
    ...
    pub fn get_table_opt(
        ...
        self.client
            .unary_call(&METHOD_BIGTABLE_TABLE_ADMIN_GET_TABLE, req, opt)
    }
    ...
    pub fn get_table_async_opt(
        ...
        self.client
            .unary_call_async(&METHOD_BIGTABLE_TABLE_ADMIN_GET_TABLE, req, opt)
    }
    ...
    pub fn delete_table_opt(
        ...
        self.client
            .unary_call(&METHOD_BIGTABLE_TABLE_ADMIN_DELETE_TABLE, req, opt)
    }
    ...
    pub fn delete_table_async_opt(
        ...
        self.client
            .unary_call_async(&METHOD_BIGTABLE_TABLE_ADMIN_DELETE_TABLE, req, opt)
    }
    ...
    pub fn modify_column_families_opt(
        ...
        self.client.unary_call(
            &METHOD_BIGTABLE_TABLE_ADMIN_MODIFY_COLUMN_FAMILIES,
            req,
            opt,
        )
    }
    ...
    pub fn drop_row_range_opt(
        ...
        self.client
            .unary_call(&METHOD_BIGTABLE_TABLE_ADMIN_DROP_ROW_RANGE, req, opt)
    }
    ...
    pub fn drop_row_range_async_opt(
        ...
        self.client
            .unary_call_async(&METHOD_BIGTABLE_TABLE_ADMIN_DROP_ROW_RANGE, req, opt)
    }
    ...
    pub fn generate_consistency_token_opt(
        ...
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<super::bigtable_table_admin::GenerateConsistencyTokenResponse> {
        self.client.unary_call(
            &METHOD_BIGTABLE_TABLE_ADMIN_GENERATE_CONSISTENCY_TOKEN,
            req,
            opt,
        )
    }
    ...
    pub fn check_consistency_opt(
        ...
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<super::bigtable_table_admin::CheckConsistencyResponse> {
        self.client
            .unary_call(&METHOD_BIGTABLE_TABLE_ADMIN_CHECK_CONSISTENCY, req, opt)
    }
    ...
    pub fn check_consistency_async_opt(
        ...
        ::grpcio::ClientUnaryReceiver<super::bigtable_table_admin::CheckConsistencyResponse>,
    > {
        self.client
            .unary_call_async(&METHOD_BIGTABLE_TABLE_ADMIN_CHECK_CONSISTENCY, req, opt)
    }
    ...
    pub fn snapshot_table_opt(
        ...
        self.client
            .unary_call(&METHOD_BIGTABLE_TABLE_ADMIN_SNAPSHOT_TABLE, req, opt)
    }
    ...
    pub fn snapshot_table_async_opt(
        ...
        self.client
            .unary_call_async(&METHOD_BIGTABLE_TABLE_ADMIN_SNAPSHOT_TABLE, req, opt)
    }
    ...
    pub fn get_snapshot_opt(
        ...
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<super::table::Snapshot> {
        self.client
            .unary_call(&METHOD_BIGTABLE_TABLE_ADMIN_GET_SNAPSHOT, req, opt)
    }
    ...
    pub fn get_snapshot_async_opt(
        ...
        req: &super::bigtable_table_admin::GetSnapshotRequest,
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::table::Snapshot>> {
        self.client
            .unary_call_async(&METHOD_BIGTABLE_TABLE_ADMIN_GET_SNAPSHOT, req, opt)
    }
    ...
    pub fn list_snapshots_opt(
        ...
        opt: ::grpcio::CallOption,
    ) -> ::grpcio::Result<super::bigtable_table_admin::ListSnapshotsResponse> {
        self.client
            .unary_call(&METHOD_BIGTABLE_TABLE_ADMIN_LIST_SNAPSHOTS, req, opt)
    }
    ...
    pub fn list_snapshots_async_opt(
        ...
        ::grpcio::ClientUnaryReceiver<super::bigtable_table_admin::ListSnapshotsResponse>,
    > {
        self.client
            .unary_call_async(&METHOD_BIGTABLE_TABLE_ADMIN_LIST_SNAPSHOTS, req, opt)
    }
    ...
    pub fn delete_snapshot_opt(
        ...
        self.client
            .unary_call(&METHOD_BIGTABLE_TABLE_ADMIN_DELETE_SNAPSHOT, req, opt)
    }
    ...
    pub fn delete_snapshot_async_opt(
        ...
        self.client
            .unary_call_async(&METHOD_BIGTABLE_TABLE_ADMIN_DELETE_SNAPSHOT, req, opt)
    }
    ...
    pub fn get_iam_policy_opt(
        ...
        self.client
            .unary_call(&METHOD_BIGTABLE_TABLE_ADMIN_GET_IAM_POLICY, req, opt)
    }
    ...
    pub fn get_iam_policy_async_opt(
        ...
        self.client
            .unary_call_async(&METHOD_BIGTABLE_TABLE_ADMIN_GET_IAM_POLICY, req, opt)
    }
    ...
    pub fn set_iam_policy_opt(
        ...
        self.client
            .unary_call(&METHOD_BIGTABLE_TABLE_ADMIN_SET_IAM_POLICY, req, opt)
    }
    ...
    pub fn set_iam_policy_async_opt(
        ...
        self.client
            .unary_call_async(&METHOD_BIGTABLE_TABLE_ADMIN_SET_IAM_POLICY, req, opt)
    }
    ...
    pub fn test_iam_permissions_opt(
        ...
        self.client
            .unary_call(&METHOD_BIGTABLE_TABLE_ADMIN_TEST_IAM_PERMISSIONS, req, opt)
    }
    ...
    > {
        self.client
            .unary_call_async(&METHOD_BIGTABLE_TABLE_ADMIN_TEST_IAM_PERMISSIONS, req, opt)
    }
...
pub fn create_bigtable_table_admin<S: BigtableTableAdmin + Send + Clone + 'static>(
    ...
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_CREATE_TABLE,
        move |ctx, req, resp| instance.create_table(ctx, req, resp),
    );
    let mut instance = s.clone();
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_CREATE_TABLE_FROM_SNAPSHOT,
        move |ctx, req, resp| instance.create_table_from_snapshot(ctx, req, resp),
    );
    let mut instance = s.clone();
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_LIST_TABLES,
        move |ctx, req, resp| instance.list_tables(ctx, req, resp),
    );
    let mut instance = s.clone();
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_GET_TABLE,
        move |ctx, req, resp| instance.get_table(ctx, req, resp),
    );
    let mut instance = s.clone();
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_DELETE_TABLE,
        move |ctx, req, resp| instance.delete_table(ctx, req, resp),
    );
    let mut instance = s.clone();
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_MODIFY_COLUMN_FAMILIES,
        move |ctx, req, resp| instance.modify_column_families(ctx, req, resp),
    );
    let mut instance = s.clone();
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_DROP_ROW_RANGE,
        move |ctx, req, resp| instance.drop_row_range(ctx, req, resp),
    );
    let mut instance = s.clone();
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_GENERATE_CONSISTENCY_TOKEN,
        move |ctx, req, resp| instance.generate_consistency_token(ctx, req, resp),
    );
    let mut instance = s.clone();
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_CHECK_CONSISTENCY,
        move |ctx, req, resp| instance.check_consistency(ctx, req, resp),
    );
    let mut instance = s.clone();
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_SNAPSHOT_TABLE,
        move |ctx, req, resp| instance.snapshot_table(ctx, req, resp),
    );
    let mut instance = s.clone();
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_GET_SNAPSHOT,
        move |ctx, req, resp| instance.get_snapshot(ctx, req, resp),
    );
    let mut instance = s.clone();
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_LIST_SNAPSHOTS,
        move |ctx, req, resp| instance.list_snapshots(ctx, req, resp),
    );
    let mut instance = s.clone();
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_DELETE_SNAPSHOT,
        move |ctx, req, resp| instance.delete_snapshot(ctx, req, resp),
    );
    let mut instance = s.clone();
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_GET_IAM_POLICY,
        move |ctx, req, resp| instance.get_iam_policy(ctx, req, resp),
    );
    let mut instance = s.clone();
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_SET_IAM_POLICY,
        move |ctx, req, resp| instance.set_iam_policy(ctx, req, resp),
    );
    let mut instance = s;
    builder = builder.add_unary_handler(
        &METHOD_BIGTABLE_TABLE_ADMIN_TEST_IAM_PERMISSIONS,
