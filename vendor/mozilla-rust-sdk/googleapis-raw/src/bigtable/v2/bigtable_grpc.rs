...
pub trait Bigtable {
    fn read_rows(&mut self, ctx: ::grpcio::RpcContext, _req: super::bigtable::ReadRowsRequest, sink: ::grpcio::ServerStreamingSink<super::bigtable::ReadRowsResponse>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn sample_row_keys(&mut self, ctx: ::grpcio::RpcContext, _req: super::bigtable::SampleRowKeysRequest, sink: ::grpcio::ServerStreamingSink<super::bigtable::SampleRowKeysResponse>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn mutate_row(&mut self, ctx: ::grpcio::RpcContext, _req: super::bigtable::MutateRowRequest, sink: ::grpcio::UnarySink<super::bigtable::MutateRowResponse>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
    fn mutate_rows(&mut self, ctx: ::grpcio::RpcContext, _req: super::bigtable::MutateRowsRequest, sink: ::grpcio::ServerStreamingSink<super::bigtable::MutateRowsResponse>) {
        grpcio::unimplemented_call!(ctx, sink)
    }
